...
class Assign_credit_report_model extends CI_Model
{
    ...
    public function select_client_list_assign_credit_report_view($tableName,$return_as_strict_row,$select_array)
	{
		$this->db->select($select_array);
