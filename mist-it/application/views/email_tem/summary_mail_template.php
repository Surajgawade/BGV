...
.div1 {
 ...
 <main>
      <br>
        ...
        <tr class="email-body">
            <td>
                ...
                <p style="text-align: justify">With reference to our conversation regarding <b><?= ucwords($email_info['CandidateName']) ?></b>, youhave provided the following feedback. Thank you for your valuable time and request you to acknowledge this email at the earliest.</p>
    ...
    <div id ="clients_disc_summary"></div> 

   <?php
    if(isset($client_disclosure_summary)) 
    {
       if($client_disclosure_summary == 'yes')
      {
    ...
    <br>
	 <table class="table-content" style="width:800px; max-width: 800px;border-spacing: 10; border-collapse: collapse;margin-bottom: 10px;" border="1">
      ...
      <!--   <tr>
            ...
            <td colspan="2"><?= (!empty($email_info['coaddress']) ? ucwords($email_info['coaddress']) : 'Please Provide') ?></td>
            <td ></td>
        </tr>
         <tr>
            <td style='background-color: #EDEDED; text-align: left; padding-left: 5px;' ><b>Company Location</b></td>
            <td colspan="2"><?= (!empty($email_info['colocation']) ? ucwords($email_info['colocation']) : 'Please Provide') ?></td>
            <td ></td>-->
        </tr>
       ...
       ?>
        ...
        <tr>
            ...
            <td ><?= ($email_info['rsl_empid'] != "") ? ucwords($email_info['rsl_empid']) : '' ?></td>
        </tr>
        <tr>
            ...
            <td ><?= ($email_info['res_employment_type'] != "") ? ucwords($email_info['res_employment_type']) : '' ?></td>
        </tr>
        <?php
				$emprst_period = ( !empty(date('d-M-Y',strtotime($email_info['employed_from'])) && !empty(date('d-M-Y',strtotime($email_info['employed_to']))) ) ? date('d-M-Y',strtotime($email_info['employed_from'])).' to '.date('d-M-Y',strtotime($email_info['employed_to'])) : '' ); 
			?>
        ...
        <tr>
         ...
         <tr>
            ...
            <td ><?= (!empty($email_info['designation']) ? ucwords($email_info['designation']) : 'Please Provide') ?></td>
             <td ><?= ($email_info['emp_designation'] != "") ? ucwords($email_info['emp_designation']) : '' ?></td>
        </tr>
         <tr>
            ...
            <td ><?= (!empty($email_info['remuneration']) ? ucwords($email_info['remuneration']) : 'Please Provide') ?></td>
             <td ><?= ($email_info['rsL_remuneration'] != "") ? ucwords($email_info['rsL_remuneration']) : '' ?></td>
        </tr>
         <tr>
            <td style='background-color: #EDEDED; text-align: left; padding-left: 5px;'><b>Reporting Manager's Name & Designation</b></td>
            <td ><?= (!empty($email_info['r_manager_name']) ? ucwords($email_info['r_manager_name']) : 'Please Provide') ?></td>
             <td ><?= ($email_info['rsl_reportingmanager'] != "") ? ucwords($email_info['rsl_reportingmanager']) : '' ?></td>
        </tr>
        <tr>
            ...
            <td><?= (!empty($email_info['res_reasonforleaving']) ? ucwords($email_info['res_reasonforleaving']) : '') ?></td>
        </tr>
     <!--<tr>
            <td style='background-color: #EDEDED; text-align: left; padding-left: 5px;'><b>Total Experience</b></td>
            <td colspan="2"><?= (!empty($email_info['year_of_experience']) ? ucwords($email_info['year_of_experience']) : 'Please Provide') ?></td>
        </tr>
        <tr>
            <td style='background-color: #EDEDED; text-align: left; padding-left: 5px;'><b>Reference Name</b></td>
            <td colspan="2"><?= (!empty($email_info['employment_reference_name']) ? ucwords($email_info['employment_reference_name']) : 'Please Provide') ?></td>
        </tr>
        <tr>
            <td style='background-color: #EDEDED; text-align: left; padding-left: 5px;'><b>Reference Phone Number</b></td>
            <td colspan="2"><?= (!empty($email_info['employment_reference_no']) ? ucwords($email_info['employment_reference_no']) : 'Please Provide') ?></td>
        </tr>
        <tr>
            <td style='background-color: #EDEDED; text-align: left; padding-left: 5px;'><b>Reporting Manager's Name</b></td>
            <td colspan="2"><?= (!empty($email_info['r_manager_name']) ? ucwords($email_info['r_manager_name']) : 'Please Provide') ?></td>
        </tr>
         <tr>
            <td style='background-color: #EDEDED; text-align: left; padding-left: 5px;'><b>Reporting Manager's Designation</b></td>
            <td colspan="2"><?= (!empty($email_info['r_manager_designation']) ? ucwords($email_info['r_manager_designation']) : 'Please Provide') ?></td>
        </tr>
         <tr>
            <td style='background-color: #EDEDED; text-align: left; padding-left: 5px;'><b>Reporting Manager's Contact Number</b></td>
            <td colspan="2"><?= (!empty($email_info['r_manager_no']) ? ucwords($email_info['r_manager_no']) : 'Please Provide') ?></td>
        </tr>
         <tr>
            <td style='background-color: #EDEDED; text-align: left; padding-left: 5px;'><b>Reporting Manager's Email ID</b></td>
            <td colspan="2"><?= (!empty($email_info['r_manager_email']) ? ucwords($email_info['r_manager_email']) : 'Please Provide') ?></td>
        </tr>-->
         <tr>
            ...
            <td colspan="2"><?= (!empty($email_info['info_exitformalities']) ? ucwords($email_info['info_exitformalities']) : '') ?></td>
        </tr>
        <tr>
            <td style='background-color: #EDEDED; text-align: left; padding-left: 5px;'><b>Exit formalities completed? (If No, please provide whether pending from Company or Candidate's end)</b></td>
            <td colspan="2"><?= (!empty($email_info['info_exitformalities']) ? ucwords($email_info['info_exitformalities']) : '') ?></td>
        ...
        <tr>
            ...
            <td colspan="2"><?= (!empty($email_info['info_integrity_disciplinary_issue']) ? ucwords($email_info['info_integrity_disciplinary_issue']) : '') ?></td>
        </tr>
         <tr>
            ...
            <td colspan="2"><?= (!empty($email_info['info_eligforrehire']) ? ucwords($email_info['info_eligforrehire']) : '') ?></td>
        </tr>
        <tr>
      ...
      <!--  <tr>
        ...
        <tr>
            ...
            <td colspan="2"><?= (!empty($email_info['remarks']) ? ucwords($email_info['remarks']) : '') ?></td>
        </tr>
        </tbody>
    </table>
	<br>
...
<script>
var empty = "<?php echo $column_empty?>";
if(empty)
{
	$('.btn_summary_mail').attr('disabled','disabled');
       ...
       $('#client_disclosure_summary').change(function(){
           
         var client_disclosure = $('#client_disclosure_summary').val();
         if(client_disclosure == 'yes')
         {
            var clients_name = <?php echo "'".ucwords($email_info['clientname'])."'" ?>;
            $("#clients_disc_summary").html('<b>Client Name : '+clients_name+'</b>'); 
         }
         else
         {
              $("#clients_disc_summary").html(''); 
         }
