  ...
  <table style="width:800px; max-width: 800px;background-color: #fff;" border="0" cellpadding="0" cellspacing="0" >
        ...
        <tr class="email-body">
            <td>
                ...
                <p style="text-align: justify;font-family: Calibri;">You are requested to visit the below link and update the required details at the earliest.</p>
              
                <p style="text-align: justify;font-family: Calibri;"><a href="<?php echo $email_info['url']; ?>"> Click here</a></p>

                <p style="text-align: justify;font-family: Calibri;">Please note these details are pending since <?php echo date('d-M-Y',strtotime($email_info['caserecddate'])) ?>, hence request you to update them immediately.</p>
        ...
        <tr class="email-body">  
            <td>
                <p style="text-align: justify;font-family: Calibri;"><b><u>Completed</u></b></p>
                <p style="text-align: justify;font-family: Calibri;"> <?php 
                  $i = 1;
                  foreach ($email_info['pending_component'] as $key => $value) {
