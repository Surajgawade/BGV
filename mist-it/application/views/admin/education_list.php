...
<div class="container-fluid">
   ...
   <div class="nav-tabs-custom">
        <ul class="nav nav-pills nav-justified"> 
           ...
           <?php  
            echo "<li class='nav-item waves-effect waves-light res active'  role='presentation' data-tab_name='education_list_view' ><a class = 'nav-link active' href='#education_list_view' aria-controls='home' data-toggle='tab'>Education List View</a></li>";
            
            echo "<li  role='presentation' data-url='".ADMIN_SITE_URL."education/get_assign_education_list_view/'  data-tab_name='assign_education_list_view'  class='nav-item waves-effect waves-light view_assign_tab'><a class = 'nav-link' href='#assign_education_list_view' aria-controls='home' role='tab'  data-toggle='tab'>New Cases</a></li>";
...
<div class="tab-content">
  <div id="education_list_view" class="tab-pane active">  
    <div class="row">
         <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Education - List View</h4>
                  <ol class="breadcrumb">
                  ...
                  <div class="state-information d-none d-sm-block">
                    <ol class="breadcrumb">
                      <?php 
                        $access_export = ($this->permission['access_education_list_export']) ? '#myModalExport'  : '';
                        $access_import = ($this->permission['access_education_list_import']) ? '#myModelImport'  : '';  
                      ?> 
          ...
          <div class="card m-b-20">
            <div class="card-body">
                <div class="row">
                 ...
                 <table id="tbl_datatable_education" class="table table-bordered  nowrap"  style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    <thead>
                      <tr>
                        <th>Sr No</th>
                        <th>Client Ref No</th>
    ...
    <div id="assign_education_list_view" class="tab-pane fade in">
...
<div id="myModalExport" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog" style="width: 700px !important;">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Export Education Records</h4>
      </div>
...
$(document).ready(function() {
  ...
  var oTable =  $('#tbl_datatable_education').DataTable( {
        "serverSide": true,
        "processing": true,
         bSortable: true,
         bRetrieve: true,
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: "<?php echo ADMIN_SITE_URL.'education/education_view_datatable'; ?>",
        ...
        "columns":[{'data' :'id'},{'data' :'ClientRefNumber'},{"data":"education_com_ref"},{"data":"iniated_date"},{"data":"clientname"},{'data' :'CandidateName'},{'data' :'vendor_name'},{'data' :'verfstatus'},{'data' :'school_college'},{'data' :'university_board'},{'data' :'qualification'},{'data' :'year_of_passing'},{"data":"executive_name"},{'data':'tat_status'},{'data':'due_date'},{'data':"last_activity_date"},{'data':"mode_of_veri"},{'data':"cmp_ref_no"}],
  ...
  $('#filter_by_executive,#filter_by_clientid,#filter_by_status,#filter_by_sub_status').on('change', function(){
    ...
    var new_url = "<?php echo ADMIN_SITE_URL.'education/education_view_datatable'; ?>?status="+status+"&sub_status="+sub_status+"&client_id="+client_id+"&filter_by_executive="+filter_by_executive;
  ...
  $('#filter_by_executive,#filter_by_status,#filter_by_sub_status').on('change', function(){
    ...
    var sub_status = $('#filter_by_sub_status').val();
     ...
     $.ajax({
          type:'POST',
          url:'<?php echo ADMIN_SITE_URL.'education/get_clients_for_education_list_view/' ?>',
    ...
    {
    var new_url = "<?php echo ADMIN_SITE_URL.'education/education_view_datatable'; ?>?status="+status+"&sub_status="+sub_status+"&client_id="+client_id+"&start_date="+start_date+"&end_date="+end_date+"&filter_by_executive="+filter_by_executive;
    oTable.ajax.url(new_url).load();
   }
  });
...
$('#btn_reset').on('click', function() {
   ...
   $("#filter_by_status option[value = All]").attr('selected','selected');
    ...
    var new_url = "<?php echo ADMIN_SITE_URL.'education/education_view_datatable'; ?>?status="+status+"&filter_by_executive="+filter_by_executive;
    oTable.ajax.url(new_url).load();
  });
  ...
  $('#btn_assign_action').on('click', function(e){
    ...
    if(users_list != '0'  && select_one != "")
    {
        $.ajax({
          type:'POST',
          url:'<?php echo ADMIN_SITE_URL.'education/assign_to_executive/' ?>',
...
$('#download_candidate_template').on('click',function(){
        ...
        $.ajax({
          url : '<?php echo ADMIN_SITE_URL.'education/template_download'; ?>',
          data : '',
          type: 'post',
          dataType:'json',
          beforeSend:function(){
...
$('#export_to_excel_frm').validate({ 
        ...
        {      
            ...
            $.ajax({
            url: '<?php echo ADMIN_SITE_URL.'education/export_to_excel'; ?>',
            data: dataString,
            type: 'POST',
            beforeSend:function(){
