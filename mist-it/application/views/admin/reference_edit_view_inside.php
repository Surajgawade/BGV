    ...
    <div class="modal-content">
      ...
      <div class="row">  
        <div class="col-md-6 col-sm-12 col-xs-6 form-group">
          ...
          <input type="text" name="reinitiated_date" id="reinitiated_date" value="<?php echo set_value('reinitiated_date',date('d-m-Y')); ?>" class="form-control 1" placeholder='DD-MM-YYYY'>
    ...
    <div class="modal-content">
      ...
      <div class="row">
        <div class="col-md-6 col-sm-12 col-xs-6 form-group">
          ...
          <input type="text" name="txt_insuff_raise" id="txt_insuff_raise" value="<?php echo set_value('txt_insuff_raise',$this->insuff_date); ?>" class="form-control 11" placeholder='DD-MM-YYYY'>
