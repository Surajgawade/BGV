<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><button class="btn btn-default btn_clicked btn-sm" data-accessUrl="<?= ADMIN_SITE_URL?>cg"><i class="fa fa-arrow-left"></i> Back</button></li> 
    </ol>
  </section>
    ...
    <div class="row">
      <div class="col-sm-12 col-md-12">
        <div class="nav-tabs-custom">
          <?php $this->load->view('admin/cg_edit'); ?> 
        </div> 
        <div class="nav-tabs-custom">
          <div class="nav-tabs-custom">
  ...
  <div class="modal-dialog" style="overflow-y: scroll; max-height:90%;width: 80%;  margin-top: 40px; margin-bottom:40px;">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="row">
            <input type="hidden" name="component_type" id="component_type" value="13">
