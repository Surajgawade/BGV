    <div class="row">
         <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Drugs/Narcotics - Assign Drugs</h4>
                  <ol class="breadcrumb">
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>dashboard"><?php echo SHORT_CO_NAME ?></a></li>
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>drugs_narcotics">Drugs/Narcotics</a></li>
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>assign_drugs">Assign Drugs</a></li>
          ...
          <div class="card m-b-20">
            <div class="card-body">
              <div class="row">
               ...
               <table id="tbl_datatable_assign"  class="table table-bordered  nowrap"  style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                  <thead>
                    <tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title header_title">Assign Vendor Cases</h4>
      </div>
...
$(document).ready(function() {
  ...
  var oTable = $('#tbl_datatable_assign').DataTable( {
      "serverSide": true,
      "processing": true,
       bSortable: true,
       bRetrieve: true,
      ...
      "ajax": $.fn.dataTable.pipeline( {
          url: "<?php echo ADMIN_SITE_URL.'assign_drugs/drug_view_datatable_assign'; ?>",
            pages: 1,
            async: true,
            method: 'POST',
        ...
        "columns":[{'data' :'checkbox'},{'data' :'id'},{'data' :'ClientRefNumber'},{"data":"drug_com_ref"},{"data":"iniated_date"},{"data":"clientname"},{'data' :'CandidateName'},{'data' :'vendor_name'},{'data' :'verfstatus'},{"data":"drug_test_code"},{"data":"street_address"},{"data":"state"},{"data":"city"},{"data":"executive_name"},{'data':'first_qc_approve'},{'data':'tat_status'},{'data':'due_date'},{'data':"last_activity_date"}]
  } );
  ...
  $('#tbl_datatable_assign tbody').on('dblclick', 'tr', function () { 
  ...
  $('#filter_by_clientid,#filter_by_status').on('change', function(){
    ...
    var new_url = "<?php echo ADMIN_SITE_URL.'drugs_narcotics/drug_view_datatable'; ?>?filter_by_clientid="+filter_by_clientid+"&filter_by_status="+filter_by_status;
    oTable.ajax.url(new_url).load();
  });

  $('#tbl_datatable_assign tbody').on( 'click', 'tr', function () {
    ...
    $('#tbl_datatable_assign').on('click', 'tbody td, thead th:first-child', function(e){
  ...
  $('#btn_assign_action_vendor').on('click', function(e){
    ...
    if(vendor_list != "0" && select_one != "")
    {
        $.ajax({
          type:'POST',
          url:'<?php echo ADMIN_SITE_URL.'drugs_narcotics/assign_to_vendor/' ?>',
...
$('#download_candidate_template').click(function(e) {
    e.preventDefault();
    window.location.href = "<?= COM_ATTACHMENTS_PATH.DRUGS.'/drug_bulk_template.xlsx'; ?>" ;
});
</script>
