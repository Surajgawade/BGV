  ...
  <div class="result_error" id="result_error"></div>
   ...
   <!-- <div class="col-sm-4 form-group">
    ...
    <div class="col-sm-4 form-group">
      ...
      <input type="text" name="res_address" id="res_address" value="<?php echo set_value('res_address',$details['res_address']); ?>" class="form-control" readonly>
    ...
    <div class="col-sm-4 form-group">
      ...
      <input type="text" name="res_city" id="res_city" value="<?php echo set_value('res_city',$details['res_city']); ?>" class="form-control" readonly>
    ...
    <div class="col-sm-4 form-group">
      ...
      <input type="text" name="res_pincode" id="res_pincode" value="<?php echo set_value('res_pincode',$details['res_pincode']); ?>" class="form-control" readonly>
    ...
    <div class="col-sm-4 form-group">
      <label>State<span class="error"> *</span></label>
       <!-- <?php
        ...
        ?>-->
        <input type="text" name="res_state" id="res_state" value="<?php echo set_value('res_state',$details['res_state']); ?>" class="form-control" readonly>
    </div>
    <div class="col-sm-4 form-group">
      <label></label>
      <br>
    ...
    <div class="col-sm-4 form-group">
      <label >Stay From <span class="error"> *</span></label>
      <input type="text" name="res_stay_from" id="res_stay_from" value="<?php echo set_value('res_state',$details['res_stay_from']); ?>" class="form-control" readonly>
    ...
    <div class="col-sm-4 form-group">
      <label >Stay To <span class="error"> *</span></label>
      <input type="text" name="res_stay_to" id="res_stay_to" value="<?php echo set_value('res_stay_to',$details['res_stay_to']); ?>" class="form-control" readonly>
                        ...
                        {   
                          ...
                          echo "</div></div></div>";
                            ...
                            { 
                               ...
                               // echo "<input type='checkbox'  name='order[]' value='".$attachments[$i]['id']."' id='order' >";
                               echo '</div></div></div>';
                            }
                        }
                        ?>
                    ...
                    if($vendor_attachments)
                        {
                          ...
                          echo "</div></div></div>";
                            ...
                            { 
                                ...
                                echo "<div class = 'row'>";
                                echo '<div class="col-md-5 col-sm-5 col-xs-5" style = "border: 1px solid black;">';
                                echo '<a href="javascript:;" ondblClick="myOpenWindow('.$url_address_vendor.$actual_file.','.$myWin.','.$attribute.'); return false"> <img src='.$url_address_vendor.$actual_file.' height = "75px" width = "75px" >';
                                echo "</div>";
