    ...
    <div class="row">
         <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Court - Court AQ</h4>
                  <ol class="breadcrumb">
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>dashboard"><?php echo SHORT_CO_NAME ?></a></li>
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>court_verificatiion">Court</a></li>
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>court_verificatiion/approval_queue">Court AQ</a></li>
     ...
     <div class="nav-tabs-custom">
        ...
        // echo "<li  role='presentation' data-url='".ADMIN_SITE_URL."address/vendor_cost_approval/' data-can_id='1' data-tab_name='vendor_cost_approve'  class='nav-item waves-effect waves-light view_component_tab'><a  class = 'nav-link'  href='#vendor_cost_approve' aria-controls='home' role='tab' data-toggle='tab'>Vendor Charges</a></li>";

   
        echo "<li  role='presentation' data-url='".ADMIN_SITE_URL."court_verificatiion/court_closure_entries/' data-can_id='100000'   data-tab_name='result_log_tabs'  class='nav-item waves-effect waves-light view_component_tab1' ><a  class = 'nav-link' href='#result_log_tabs' aria-controls='home' role='tab'  data-toggle='tab'>Closure</a></li>";


         echo "<li  role='presentation' data-url='".ADMIN_SITE_URL."court_verificatiion/court_closure_entries_vendor_insuff/' data-can_id='".$this->user_info['id']."'   data-tab_name='vendor_insuff_tab'  class='nav-item waves-effect waves-light view_component_tab1'><a class = 'nav-link' href='#vendor_insuff_tab' aria-controls='home' role='tab'  data-toggle='tab'>Vendor Insuff</a></li>";
...
<div id="addAddResultModel" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-lg" >
    ...
    <div class="modal-content">
      ...
      <input type="hidden" id="courtver_id" name="courtver_id" value="<?php echo set_value('courtver_id'); ?>">
      <input type="hidden" id="clientid"  name="clientid" value="<?php echo set_value('clientid'); ?>">
       <input type="hidden" id="adv_name"  name="adv_name" value="<?php echo set_value('adv_name'); ?>">


      <input type="hidden" id="court_result_id" name="courtver_result_id" value="<?php echo set_value('court_result_id'); ?>">
...
<div id="showvendorModel" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-lg" >
    ...
    <div class="modal-content">
      ...
      <input type="hidden" name="court_id" id = "court_id"  class = "court_id" value="">
     ...
     <div class="showbutton1" style="display: none;">
      ...
      ="<?= ADMIN_SITE_URL.'activity_log/activity_log_view_vendor_form/3/' ?>" data-toggle="modal" id="activityModelClk1" type="button" >Approve</button>
...
<div id="showvendorModelIsuff" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-lg" >
    ...
    <div class="modal-content">
      <div class="modal-header">
       ...
       <input type="hidden" name="court_insuff_id" id = "court_insuff_id"  class = "court_insuff_id" value="">
      <input type="hidden" name="closure_insuff_id" id = "closure_insuff_id"  class = "closure_insuff_id" value="">
       
      <div class="modal-body">
        <span class="errorTxt"></span>
        <div id="append_vendor_model_insuff_deatils"></div>
      </div>
      <div class="modal-footer">
      <button type="button" id="vendor_details_insuff_back" name="vendor_details_insuff_back" class="btn btn-default btn-sm pull-left">Back</button>
      
      <button  class="btn btn-success btn-sm approve_reject_insuff_id" data-url
      ="<?= ADMIN_SITE_URL.'court_verificatiion/check_insuff_already_raised' ?>" data-toggle="modal" id="Insuff_raised_md" type="button" >Approve</button>
      <button  class="btn btn-danger btn-sm approve_reject_insuff_id" data-toggle="modal" data-target="#reject_value_insuff"  type="button" >Reject</button>
      <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
...
<div id="reject_value_insuff" class="modal fade" role="dialog" style="z-index: 2000;">
  <div class="modal-dialog">
    <!-- Modal content-->
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <input type="text" name="reject_reason_insuff" maxlength="200" id="reject_reason_insuff" placeholder="Reason" class="form-control">
       <br>

        <button type="button" id="reject_insuff" name="reject_insuff" class="btn btn-danger btn-sm" value = '2'>Reject</button>
...
$(document).ready(function() {
  ...
  var oTable =  $('#tbl_datatable').DataTable( {
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: "<?php echo ADMIN_SITE_URL.'court_verificatiion/view_approval_queue'; ?>",
        ...
        "columns":[{'data' :'checkbox'},{'data' :'id'},{"data":"court_com_ref"},{"data":"clientname"},{"data":"entity_name"},{"data":"package_name"},{'data' :'vendor_name'},{'data' :'city'},{'data' :'pincode'},{'data' :'state'},{'data' :'allocated_by'},{"data":"allocated_on"}]
  });
...
$(document).on('click', '#btn_assign', function(){
    ...
    { 
       ...
       else
       {
        ...
        $.ajax({
          type:'POST',
          url:'<?php echo ADMIN_SITE_URL.'court_verificatiion/court_final_assigning/' ?>',
    ...
    { 
      ...
      if(cases_assgin_action == 2 && reject_reason == "")
       ...
       else
       {
        ...
        $.ajax({
          type:'POST',
          url:'<?php echo ADMIN_SITE_URL.'court_verificatiion/court_closure/' ?>',
...
$(document).on('click', '#reject_insuff', function(){
     var cases_assgin_action = $('#reject_insuff').val();
     var selected_id = $('#closure_insuff_id').val();  
     var reject_reason = $('#reject_reason_insuff').val();  
      ...
      {  
        ...
        $.ajax({
          ...
          success:function(jdata)
          {
            ...
            if(jdata.status == '<?php echo SUCCESS_CODE; ?>'){
              show_alert(message,'success');
              $('#reject_value_insuff').modal('hide');
              $('#showvendorModelIsuff').modal('hide');
              $('.view_component_tab a.active').click();
...
$('#activityModelClk1').click(function(){
    ...
    var id = $('#court_id').val();
    var component = 'court_verificatiion';
...
$(document).on('click','#activityModelClk1',function() {
 ...
 var court_result_id  = $('#court_result_id1').val();


 document.getElementById("courtver_id").value = component_id; 
 ...
 document.getElementById("court_result_id").value = court_result_id; 
...
$('.approve_reject_insuff_id').click(function(){
 var cl_id  = $('#cl_id').val();
 document.getElementById("closure_insuff_id").value = cl_id; 
});

});

$('#Insuff_raised_md').click(function(){
 
    var url = $(this).data('url');

    var court_insuff_id =  $('#court_insuff_id').val();
    
   $('#append_vendor_model_insuff').load(url+"/"+court_insuff_id,function(){
    ...
    { 
      ...
      $.ajax({
        ...
        success: function(jdata){
          ...
          if(final_status == 'Clear' || final_status == 'Possible Match')
          {
            var cases_as = 1;
            var selected_id =  $('#closure_id').val();
          ...
          success: function(jdata){
            ...
            if(jdata.redirect){
             ...
             // location.reload();
              ...
              // $('.view_component_tab').attr('data-can_id',2);
              var last_id =  $('#filter_clientid').val();
           
              $(".view_component_tab1").attr('can_id',last_id);


              $('.view_component_tab1 a.active').click();
...
$(document).on('click', '.view_component_tab1', function(){

     var last_id =  $(this).attr('can_id');

    var can_id = $(this).data('can_id');
