<div class="modal-body">
  ...
  <div class="row">
    ...
    <div class="col-md-4 col-sm-12 col-xs-4 form-group">
      ...
      <input type="text" name="court_com_ref" id="court_com_ref" readonly="readonly" value="<?php echo set_value('court_com_ref',$details['court_com_ref']); ?>" class="form-control">
    ...
    <div class="col-md-4 col-sm-12 col-xs-4 form-group">
      <label>Remarks</label>
      <textarea id="remarks" name="remarks" class="form-control add_res_remarks" rows="1" maxlength="500"><?php echo set_value('attchments_ver',$details['res_remarks']); ?></textarea>
      <?php echo form_error('attchments_ver'); ?>
    </div>
  </div>
</div>
