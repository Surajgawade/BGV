<div class="content-wrapper">
    <section class="content-header">
      <h1>Employment Report Export</h1>
      <ol class="breadcrumb">
            ...
            <?php echo form_open('#', array('name'=>'frm_address_report','id'=>'frm_address_report')); ?>
              <div class="box-body">
                ...
                <div class="col-md-4 col-sm-8 col-xs-4 form-group">
                  ...
                  <?php
                   echo form_dropdown('nameofthecompany', $company_list, set_value('nameofthecompany'), 'class="form-control" id="nameofthecompany"');
                ...
                <div class="col-md-4 col-sm-12 col-xs-4 form-group">
                  ...
                  <?php
                   echo form_dropdown('modeofverification', $this->emp_modeofverification, set_value('modeofverification'), 'class="form-control" id="modeofverification"');
...
$(document).ready(function(){
  ...
  $('#frm_address_report').validate({ 
    ...
    {      
        $.ajax({
            url : '<?php echo ADMIN_SITE_URL.'reports/employment_export'; ?>',
