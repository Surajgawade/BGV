   <div class="row">
         <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Identity - Assign Identity</h4>
                  <ol class="breadcrumb">
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>dashboard"><?php echo SHORT_CO_NAME ?></a></li>
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>identity">Identity</a></li>
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>assign_identity">Assign Identity</a></li>
                     <li class="breadcrumb-item active">List View</li>
                  </ol>
            
                  <div class="state-information d-none d-sm-block">
                    <ol class="breadcrumb">
                      <?php $access_export = ($this->permission['access_identity_list_export']) ? '#myModalExport'  : ''; ?>
          ...
          <div class="card m-b-20">
            <div class="card-body">
              <div class="row">
                ...
                <table id="tbl_datatable_assign_identity"  class="table table-bordered  nowrap"  style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                  <thead>
                    <tr>
...
$(document).ready(function() {
  ...
  var oTable =  $('#tbl_datatable_assign_identity').DataTable( {
        "serverSide": true,
        "processing": true,
         bSortable: true,
         bRetrieve: true,
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: "<?php echo ADMIN_SITE_URL.'assign_identity/identity_view_datatable_assign'; ?>",
            pages: 1,
            async: true,
            method: 'POST',
        ...
        "columns":[{'data' :'checkbox'},{'data' :'id'},{'data' :'ClientRefNumber'},{'data' :'identity_com_ref'},{'data' :'iniated_date'},{"data":"clientname"},{"data":"CandidateName"},{"data":"verfstatus"},{'data' :'id_number'},{'data' :'executive_name'},{"data":"first_qc_approve"},{"data":"tat_status"},{"data":"due_date"},{'data':"last_activity_date"}]
  } );
  ...
  $('#tbl_datatable_assign_identity tbody').on('dblclick', 'tr', function () { 
  ...
  $('#tbl_datatable_assign_identity tbody').on( 'click', 'tr', function () {
    ...
    $('#tbl_datatable_assign_identity').on('click', 'tbody td, thead th:first-child', function(e){
  ...
  $('#filter_by_clientid,#filter_by_status').on('change', function(){
    ...
    var new_url = "<?php echo ADMIN_SITE_URL.'assign_identity/identity_view_datatable_assign'; ?>?filter_by_clientid="+filter_by_clientid+"&filter_by_status="+filter_by_status;
  ...
  $('#btn_assign_action_vendor').on('click', function(e){
    ...
    if(vendor_list != "0" && select_one != "")
    {
        $.ajax({
          type:'POST',
          url:'<?php echo ADMIN_SITE_URL.'identity/assign_to_vendor/' ?>',
