  ...
  $('#view_tab_vendor_log').click(function(){
    $.ajax({
      ...
      success:function(jdata)
      {
        ...
        var tbl_vendor_log =  $('#tbl_vendor_log').DataTable( { "ordering": true,searching: false,bFilter: false,bLengthChange : true,bSortable: true,bRetrieve: true,"iDisplayLength": 5,"lengthChange": true,"lengthMenu": [[5,25, 50, -1], [5,25, 50, "All"]],"aaSorting": [] });
