                          ...
                          {  
                           ...
                           // echo  "<td>".$list['pincode']."</td>";
                            ...
                            echo  "<td style='white-space: nowrap;'>";
                              echo '<button data-id='.$list['vendor_master_log_id'].' data-url ="'.ADMIN_SITE_URL.'education/View_vendor_log/'.$list['vendor_master_log_id'].'" data-toggle="modal" data-target="#showvendorModel"  class="btn btn-sm btn-info  showvendorModel"> View </button>';
                            ?>
                            ...
                            { ?>
                            <button class="btn btn-sm btn-info approve"  data-url="<?= ADMIN_SITE_URL.'education/apperovecost/' ?>" data-id="<?php  echo $list['vendor_cost_details_id']  ?>" data-vendor_master_id="<?php  echo $list['vendor_master_log_id']  ?>" data-amount="<?php  echo $list['cost'] ?>"  data-add_amount="<?php  echo $list['additional_cost'] ?>">Approve</button>
                          <?php } ?>
                               ...
                               { ?>
                              <button class="btn btn-sm btn-info reject"    data-url="<?= ADMIN_SITE_URL.'education/rejectcost/' ?>" data-id="<?php  echo $list['vendor_cost_details_id']  ?>" data-vendor_master_id="<?php  echo $list['vendor_master_log_id']  ?>" data-amount="<?php  echo $list['cost'] ?>"  data-add_amount="<?php  echo $list['additional_cost'] ?>">Reject</button>
                            <?php } ?>
...
<script type="text/javascript">
  ...
  $(".approve").click(function(e) {
   ...
   var vendor_master_log_id   = $(this).attr("data-vendor_master_id");
    ...
    $.ajax({
          type: "POST",
          url: '<?php echo ADMIN_SITE_URL.'address/apperovecost' ?>',
  ...
  $(".reject").click(function(e) {
    ...
    $.ajax({
          type: "POST",
          url: '<?php echo ADMIN_SITE_URL.'address/rejectcost' ?>',
