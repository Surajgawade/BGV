...
<br>
  <section class="content-report" style="border-style: double; margin:15px; margin-top:-15px;">
    <div class="row">
          ...
          <body>
            ...
            <table width="97%" cellpadding="5" cellspacing="pixels" style='border:2px solid;'>
              ...
              <tr>
                ...
                <td bgcolor="#ccc"  style='border-right:2px solid;'><b> DATE OF BIRTH</b></td>
           ...
           if(!empty($address))
             {
              ...
              foreach ($address as $key => $value)  {
                ...
                echo "<td ><input type='text' name='add_comment' class='form-control' value='".$value['remarks']."'></td>";
                echo "</tr>";
                echo "<tr>";
                ...
                echo "<td><input type='text' name='res_remarks' class='form-control' value='".$value['remarks']."'></td>";
                echo "</tr>";
                echo "</table>";
            ...
            if(!empty($drug))
           {
              foreach ($drug as $key => $value)  {
                ...
                echo "</tr>"; 
                echo "<tr>";
                echo "<td bgcolor='#ccc' style='border:2px solid;'><b> AMPHETAMINE SCREEN, URINE</b></td>";
                echo "<td><input type='text' name='' class='form-control' value='".$value['amphetamine_screen']."' ></td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td bgcolor='#ccc' style='border:2px solid;'><b> CANNABINOIDS SCREEN, URINE</b></td>";
                echo "<td><input type='text' name='' class='form-control' value='".$value['cannabinoids_screen']."' ></td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td bgcolor='#ccc' style='border:2px solid;'><b> COCAINE SCREEN, URINE</b></td>";
                echo "<td><input type='text' name='' class='form-control' value='".$value['cocaine_screen']."' ></td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td bgcolor='#ccc' style='border:2px solid;'><b> OPIATES SCREEN, URINE</b></td>";
                echo "<td><input type='text' name='' class='form-control' value='".$value['opiates_screen']."' ></td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td bgcolor='#ccc' style='border:2px solid;'><b> PHENCYCLIDINE SCREEN, URINE</b></td>";
