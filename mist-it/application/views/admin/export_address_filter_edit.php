      ...
      <div class="row">
        <div class="col-sm-12 col-md-12">
          <div class="box box-primary">
            <?php $filter = json_decode($details['filter'],true); ?>
            <?php echo form_open('#', array('name'=>'frm_address_report','id'=>'frm_address_report')); ?>
              <div class="box-body">
                ...
                <div class="col-md-4 col-sm-12 col-xs-4 form-group">
                  ...
                  <?php
                    echo form_dropdown('clientid', $clients, set_value('clientid',$filter['clientid']), 'class="form-control" id="clientid"');
                ...
                <div class="col-md-4 col-sm-12 col-xs-4 form-group">
                  ...
                  <?php
                    echo form_dropdown('entity', array(), set_value('entity',$filter['package']), 'class="form-control" id="entity"');
                ...
                <div class="col-md-4 col-sm-12 col-xs-4 form-group">
                  ...
                  <div class="input-group input-daterange">
                      <input type="text" name="overallclosuredate_from" id="overallclosuredate_from" value="<?php echo set_value('overallclosuredate_from',$filter['overallclosuredate_from']); ?>" class="form-control">
                      <div class="input-group-addon">to</div>
                      <input type="text" name="overallclosuredate_to" id="overallclosuredate_to" value="<?php echo set_value('overallclosuredate_to',$filter['overallclosuredate_to']); ?>" class="form-control">
                  </div>
                </div>
                <div class="clearfix"></div>
                ...
                <div class="col-md-4 col-sm-12 col-xs-4 form-group">
                  <label>Case Received Date<span class="error"> *</span></label>
                  <div class="input-group input-daterange">
                      <input type="text" name="iniated_date_from" id="iniated_date_from" value="<?php echo set_value('iniated_date_from',$filter['iniated_date_from']); ?>" class="form-control" >
                      <div class="input-group-addon">to</div>
                      <input type="text" name="iniated_date_to" id="iniated_date_to" value="<?php echo set_value('iniated_date_to',$filter['iniated_date_to']); ?>" class="form-control" >
                  </div>
                </div>
                <div class="col-md-4 col-sm-8 col-xs-4 form-group">
                  <label>Address type</label>
                  <?php
                   echo form_dropdown('address_type', ADDRESS_TYPE, set_value('address_type',$filter['address_type']), 'class="form-control" id="address_type"');
                    echo form_error('address_type'); 
                  ?>
                </div>
                <div class="col-md-4 col-sm-12 col-xs-4 form-group">
                  <label>Street Address</label>
                  <textarea name="address" rows="1" id="address" class="form-control"><?php echo set_value('address',$filter['address']); ?></textarea>
                ...
                <div class="col-md-4 col-sm-12 col-xs-4 form-group">
                  <label>City</label>
                  <input type="text" name="city" id="city" value="<?php echo set_value('city',$filter['city']); ?>" class="form-control">
                  <?php echo form_error('city'); ?>
                </div>
                <div class="col-md-4 col-sm-12 col-xs-4 form-group">
                  <label>Pincode</label>
                  <input type="text" name="pincode" maxlength="6" id="pincode" value="<?php echo set_value('pincode',$filter['pincode']); ?>" class="form-control">
                  <?php echo form_error('pincode'); ?>
                </div>
                <div class="col-md-4 col-sm-12 col-xs-4 form-group">
                  <label>State</label>
                  <?php
                    echo form_dropdown('state', $states, set_value('state',$filter['state']), 'class="form-control singleSelect" id="state"');
                ...
                <div class="col-md-4 col-sm-12 col-xs-4 form-group">
                  ...
                  <?php
                    echo form_dropdown('has_case_id', $assigned_user_id, set_value('has_case_id',$filter['has_case_id']), 'class="form-control" id="has_case_id"');
                ...
                <div class="col-md-4 col-sm-12 col-xs-4 form-group">
                  ...
                  <?php 
                    ...
                    echo form_dropdown('verfstatus', $status, set_value('verfstatus',$filter['verfstatus']), 'class="form-control" id="verfstatus"');
                  ?>
                </div>
                <div class="col-md-4 col-sm-12 col-xs-4 form-group">
                  <label>Sub Status<span class="error"> *</span></label>
                  <?php $sub_status =  $sub_status[0] = 'Sub Status'; echo form_dropdown('filter_by_sub_status', $sub_status, set_value('filter_by_sub_status',$filter['filter_by_sub_status']), 'class="form-control" id="filter_by_sub_status"');?>
                </div>
                <div class="col-md-4 col-sm-12 col-xs-4 form-group">
                  <label>Mode of verification</label>
                  <?php
                   echo form_dropdown('mode_of_verification', $this->mode_of_verification, set_value('mode_of_verification',$filter['mode_of_verification']), 'class="form-control" id="mode_of_verification"');
                ...
                <div class="col-md-4 col-sm-12 col-xs-4 form-group">
                  ...
                  <div class="input-group input-daterange">
                      <input type="text" name="closuredate_from" id="closuredate_from" value="<?php echo set_value('closuredate_from',$filter['closuredate_from']); ?>" class="form-control">
                      <div class="input-group-addon">to</div>
                      <input type="text" name="closuredate_to" id="closuredate_to" value="<?php echo set_value('closuredate_to',$filter['closuredate_to']); ?>" class="form-control">
                  </div>
                </div>
                <div class="clearfix"></div>
                <div class="box-body">
