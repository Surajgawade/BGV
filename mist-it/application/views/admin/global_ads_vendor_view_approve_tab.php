...
<input type="hidden" name="glodbver_id" id="global_id" value="<?php echo set_value('global_id',$details['id']); ?>">
...
<input type="hidden" name="component_ref_no" id="component_ref_no" value="<?php echo set_value('component_ref_no',$details['global_com_ref']); ?>">
...
<input type="hidden" name="glodbver_result_id" id="global_result_id1" value="<?php echo set_value('global_result_id',$details['global_result_id']); ?>">
