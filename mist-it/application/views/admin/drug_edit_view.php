  ...
  <div class="row">
        <div class="col-sm-12">
          <div class="page-title-box">
            <h5 class="page-title">Edit Drugs Verification</h5>
              <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>dashboard"><?php echo SHORT_CO_NAME ?></a></li>
                  <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>drugs_narcotics">Drugs Verification</a></li>
                  <li class="breadcrumb-item active">Drugs Verification Edit</li>
              </ol>
            
              <div class="state-information d-none d-sm-block">
                <ol class="breadcrumb">
                    <li><button class="btn btn-secondary waves-effect btn_clicked btn-sm" data-accessUrl="<?= ADMIN_SITE_URL?>drugs_narcotics"><i class="fa fa-arrow-left"></i> Back</button></li>  
               </ol>
              </div>
          </div>
        </div>
       ...
       <div class="card-body">
        <div class="nav-tabs-custom">
          <ul class="nav nav-pills nav-justified" role="tablist">
            <li class="nav-item waves-effect waves-light active"><a class = 'nav-link active' href="#address_tab" data-toggle="tab">Drug Details</a></li>
          ...
          <div class="tab-content">
            <div class="active tab-pane" id="address_tab">
              <?php $this->load->view('admin/drug_edit'); ?> 
            </div>
      ...
      <div class="card-body">    
        <div class="nav-tabs-custom">
          <ul class="nav nav-pills nav-justified">
              ...
              <li class="nav-item waves-effect waves-light"><a class = 'nav-link' href="#clk_insuff" id='clk_insuff_log' data-emp_id="<?php echo $selected_data['drug_narcotis_id']; ?>" data-toggle="tab">Insufficiency</a></li>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="clk_insuff">
                <div style="float: right;"><button class="btn btn-info btn-sm InsuffRaiseModel" data-editUrl='<?=($this->permission['access_drugs_list_insuff_raise']) ? $insuff_raise_id : ''; ?>' <?php echo $check_insuff_raise;?>>Raise Insuff</button><br>
                </div>
              ...
              <?php
               if($reinitiated == "1")
               {
                ...
                $access_reverification = ($this->permission['access_drugs_list_reverification'] == '1') ? 'ReInitiateModel'  : '';
              ?>
              ...
              <br>
                <br>
                <table id="tbl_drugs_narcotics_result" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%"></table>
              </div>
...
<div id="addAddResultModel" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static" style="overflow-y: scroll;">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <input type="hidden" name="drug_narcotis_result_id" value="<?php echo set_value('drug_narcotis_result_id',$selected_data['drug_narcotis_result_id']); ?>">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="hidden" name="update_id" id="update_id" value="<?php echo set_value('update_id',$selected_data['drug_narcotis_id']); ?>">
  ...
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="row">
            <input type="hidden" name="component_type" value="7">
            <input type="hidden" name="acti_candsid" value="<?php echo set_value('acti_candsid',$get_cands_details['candsid']); ?>">
            <input type="hidden" name="comp_table_id" value="<?php echo set_value('comp_table_id',$selected_data['drug_narcotis_id']); ?>">
            <input type="hidden" name="ac_ClientRefNumber" value="<?php echo set_value('ac_ClientRefNumber',$get_cands_details['ClientRefNumber']); ?>">
            <input type="hidden" name="component_ref_no" id="component_ref_no" value="<?php echo set_value('component_ref_no',$selected_data['drug_com_ref']); ?>">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" name="clear_update_id" id="clear_update_id" value="<?php echo set_value('clear_update_id',$selected_data['drug_narcotis_id']); ?>">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="row">
            ...
            <input type="hidden" name="pccver_id" id="pccver_id" value="<?php echo set_value('pccver_id',$selected_data['drug_narcotis_id']); ?>">
            <input type="hidden" name="fq_drug_narcotis_result_id" id="fq_drug_narcotis_result_id" value="<?php echo set_value('fq_drug_narcotis_result_id',$selected_data['drug_narcotis_result_id']); ?>">
            <div class="col-md-4 col-sm-12 col-xs-4 form-group">
...
<div id="showvendorModel" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <input type="hidden" name="drugs_id" value="<?php echo set_value('drugs_id',$selected_data['drug_narcotis_id']); ?>">
...
$(document).on('click','.InsuffRaiseModel',function() {
  ...
  var access_insuff = <?=($this->permission['access_drugs_list_insuff_raise']) ? 1 : 2 ; ?>;
...
$(document).on('click', '#clk_insuff_log', function(){
  ...
  if(emp_id != 0)
  {
      $.ajax({
          type:'GET',
          url:'<?php echo ADMIN_SITE_URL.'drugs_narcotics/insuff_tab_view/'; ?>'+emp_id,
          beforeSend :function(){
...
$(document).on('click','.clkInsuffRaiseModel',function() {
  ...
  if(insuff_data != "")
  {
    ...
    $.ajax({
        type:'POST',
        url:'<?php echo ADMIN_SITE_URL.'drugs_narcotics/insuff_edit_clear_raised_data/'; ?>',
...
$(document).on('click','.ReInitiateModel',function() {
  ...
  $('#ReInitiateModel').css({background: "#0000004d"}); 
    ...
    {      
        $.ajax({
          url : '<?php echo ADMIN_SITE_URL.'drugs_narcotics/drugs_narcotics_reinitiated_date'; ?>',
...
$(document).on('click','.insuffClearModel',function() {
  ...
  if(insuff_data != "")
  {
    $.ajax({
        type:'POST',
        url:'<?php echo ADMIN_SITE_URL.'drugs_narcotics/insuff_raised_data/'; ?>',
        data : 'insuff_data='+insuff_data,
        dataType:'json',
        beforeSend :function(){
...
$(document).on('click','.insuffDelete',function() {
  ...
  if(insuff_data != "")
  {
    $.ajax({
        type:'POST',
        url:'<?php echo ADMIN_SITE_URL.'drugs_narcotics/insuff_delete'; ?>',
...
$(document).ready(function(){
  ...
  $('#frm_edit_insuff_raise').validate({ 
    ...
    {      
        $.ajax({
          url : '<?php echo ADMIN_SITE_URL.'drugs_narcotics/update_insuff_details'; ?>',
          data : new FormData(form),
          type: 'post',
          contentType:false,
          cache: false,
  ...
  $('#frm_insuff_raise').validate({ 
    ...
    {      
        $.ajax({
          url : '<?php echo ADMIN_SITE_URL.'drugs_narcotics/insuff_raised'; ?>',
          data : new FormData(form),
          type: 'post',
          contentType:false,
          cache: false,
  ...
  $('#frm_insuff_clear').validate({ 
    ...
    {      
        $.ajax({
          url : '<?php echo ADMIN_SITE_URL.'drugs_narcotics/insuff_clear'; ?>',
          data : new FormData(form),
          type: 'post',
          contentType:false,
          cache: false,
  ...
  $('#view_tab_vendor_log').click(function(){
    $.ajax({
      type : 'POST',
      url : '<?php echo ADMIN_SITE_URL.'drugs_narcotics/vendor_logs/'.$selected_data['drug_narcotis_id']; ?>',
      data: '',
      beforeSend :function(){
  ...
  $('#view_insuff_log_tabs').click(function(){
    $.ajax({
      type : 'POST',
      url : '<?php echo ADMIN_SITE_URL.'pcc/address_logs/'.$selected_data['drug_narcotis_id']; ?>',
      data: '',
      beforeSend :function(){
  ...
  $('#view_result_log_tabs').click(function(){
    $.ajax({
      type : 'POST',
      url : '<?php echo ADMIN_SITE_URL.'drugs_narcotics/drugs_narcotics_result_list/'.$selected_data['drug_narcotis_id']; ?>',
      data: '',
      beforeSend :function(){
        jQuery('#tbl_drugs_narcotics_result').html("Loading..");
      },
      success:function(jdata)
      {
        var message = jdata.message;
        if(jdata.status = 200)
        {
          $('#tbl_drugs_narcotics_result').html(message);
        }
        else {
          $('#tbl_drugs_narcotics_result').html(message);
        }
        
        var tbl_drugs_narcotics_result =  $('#tbl_drugs_narcotics_result').DataTable( {scrollX: true,"autoWidth": false, "ordering": true,searching: false,bFilter: false,bLengthChange : false,bSortable: true,bRetrieve: true,"iDisplayLength": 5,"lengthChange": true,"lengthMenu": [[5,25, 50, -1], [5,25, 50, "All"]],"aaSorting": []  });

          tbl_drugs_narcotics_result.columns.adjust().draw();
      }
    }); 
  });
  ...
  $('#view_activity_log_tabs').click(function(){
      $.ajax({
        type : 'POST',
        url : '<?php echo ADMIN_SITE_URL.'activity_log/activity_log_databale/'.$selected_data['drug_narcotis_id'].'/7'; ?>',
        data: '',
          beforeSend :function(){
  ...
  $('#add_verificarion_result').validate({
      ...
      submitHandler: function(form) 
      { 
        var activityData = $('#add_verificarion_result').serialize()+'&'+$('#cases_activity').serialize()+"&activity_status_val=" + $("#activity_status option:selected").text()+ "&activity_mode_val=" + $("#activity_mode option:selected").text()+ "&activity_type_val=" + $("#activity_type option:selected").text()+ "&action_val=" + $("#action option:selected").text()+'&component_type=7'+'&auto_tag=3'+'&remarks='+$('.add_res_remarks').val();
        $.ajax({
        ...
        $.ajax({
          url: '<?php echo ADMIN_SITE_URL.'drugs_narcotics/add_verificarion_result'; ?>',
          data:  activityData,
          type: 'post',
          contentType:false,
          cache: false,
  ...
  $('#frm_drugs_update').validate({ 
    ...
    {
      $.ajax({
        url : '<?php echo ADMIN_SITE_URL.'drugs_narcotics/update_form'; ?>',
        data : new FormData(form),
        type: 'post',
        contentType:false,
        cache: false,
        ...
        dataType:'json',
        beforeSend:function(){
          $('#btn_drug_update').attr('disabled','disabled');
          jQuery('.body_loading').show();
        },
        complete:function(){
         // $('#btn_drug_update').attr('disabled',false);
  ...
  $('#add_verificarion_result_view').validate({
      ...
      { 
        ...
        $.ajax({
          url: '<?php echo ADMIN_SITE_URL.'drugs_narcotics/add_verificarion_ver_result'; ?>',
          data : new FormData(form),
          type: 'post',
          contentType:false,
          cache: false,
  ...
  $('#add_vendor_details_view').validate({
    ...
    rules: {
      ...
      { 
        ...
        $.ajax({
          url : "<?php echo ADMIN_SITE_URL.'drugs_narcotics/Save_vendor_details'; ?>",
          data :  activityData,
          type: 'post',
          async:false,
          cache: false,
    ...
    $('#add_vendor_details_view_cancel').validate({
      ...
      //  var activityData   =    new FormData(form);
        ...
        $.ajax({
          url : "<?php echo ADMIN_SITE_URL.'Drugs_narcotics/Save_vendor_details_cancel'; ?>",
          data :   new FormData(form),
          type: 'post',
          contentType:false,
          cache: false,
 ...
 $(document).on('click','.showvendorModel_cancel',function() {
    ...
    var permissionid = <?php echo ($this->permission['access_drugs_aq_allow'] == '1') ? '1'  : '2' ?>;
    if(permissionid == '1'){
      var url = $(this).data('url');
