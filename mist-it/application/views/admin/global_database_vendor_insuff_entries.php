                    ...
                    <table id="tbl_vendor_insuff" class="table table-bordered  nowrap"  style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                      ...
                      <?php
                        ...
                        foreach ($vendor_executive_list as $key => $value) {
                           $html_view .= "<tr id = ".$value['global_database_id']." url = ".ADMIN_SITE_URL."global_database/check_insuff_already_raised/".$value['global_database_id']." >";
                            $html_view .= "<td>".$i."</td>";
                            ...
                            $html_view .= "<td>".$value['global_com_ref']."</td>";
...
/* $('#filter_executive_insuff').on('change', function(){
    ...
    $.ajax({
            type:'GET',
            url:'<?php echo ADMIN_SITE_URL.'global_database/global_database_closure_entries_vendor_insuff/' ?>'+filter_executive,
            data : '',
            dataType:'html',
