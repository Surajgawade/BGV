      <div class="row">
         <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Global DB - Assign Global</h4>
                  <ol class="breadcrumb">
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>dashboard"><?php echo SHORT_CO_NAME ?></a></li>
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>global_database">Global DB</a></li>
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>assign_global">Assign Global</a></li>
                     <li class="breadcrumb-item active">List View</li>
                  </ol>
            
                  <div class="state-information d-none d-sm-block">
                    <ol class="breadcrumb">
                      <?php $access_export = ($this->permission['access_global_list_export']) ? '#myModalExport'  : ''; ?>
          ...
          <div class="card m-b-20">
            <div class="card-body">
              <div class="row">
                ...
                <table id="tbl_datatable_assign_global"  class="table table-bordered  nowrap"  style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                  <thead>
                    <tr>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <?php $vendor_list_mode = array('written'=> 'Written');
...
$(document).ready(function() {
  ...
  var oTable =  $('#tbl_datatable_assign_global').DataTable( {
        "serverSide": true,
        "processing": true,
         bSortable: true,
         bRetrieve: true,
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: "<?php echo ADMIN_SITE_URL.'assign_global/global_database_view_datatable_assign'; ?>",
            pages: 1,
            async: true,
            method: 'POST',
        ...
        "columns":[{'data' :'checkbox'},{'data' :'id'},{'data' :'ClientRefNumber'},{"data":"global_com_ref"},{"data":"iniated_date"},{"data":"clientname"},{'data' :'CandidateName'},{'data' :'vendor_name'},{'data' :'verfstatus'},{"data":"street_address"},{"data":"state"},{"data":"city"},{"data":"executive_name"},{'data':'first_qc_approve'},{'data':'tat_status'},{'data':'due_date'},{'data':"last_activity_date"}]
  } );
  ...
  $('#tbl_datatable_assign_global tbody').on('dblclick', 'tr', function () { 
  ...
  $('#tbl_datatable_assign_global tbody').on( 'click', 'tr', function () {
    ...
    $('#tbl_datatable_assign_global').on('click', 'tbody td, thead th:first-child', function(e){
  ...
  $('#filter_by_clientid,#filter_by_status').on('change', function(){
    ...
    var new_url = "<?php echo ADMIN_SITE_URL.'global_database/global_database_view_datatable'; ?>?filter_by_clientid="+filter_by_clientid+"&filter_by_status="+filter_by_status;
  ...
  $('#btn_assign_action_vendor').on('click', function(e){
    ...
    if(vendor_list != "0" && select_one != "")
    {
        $.ajax({
          type:'POST',
          url:'<?php echo ADMIN_SITE_URL.'global_database/assign_to_vendor/' ?>',
...
$('#download_candidate_template').click(function(e) {
    e.preventDefault();
    window.location.href = "<?= COM_ATTACHMENTS_PATH.GLOBAL_DB.'/global_bulk_template.xlsx'; ?>" ;
});
</script>
