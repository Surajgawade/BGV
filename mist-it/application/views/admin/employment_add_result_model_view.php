<div class="modal-body">
   ...
   if(($url == "StopCheck") || ($url == "NA") || ($url == "NotApplicable") || ($url == "OverseasCheck") || ($url == "WorkedWithTheSameOrganization") || ($url == "UnableToVerify"))
   {
...
?>
  ...
  <input type="hidden" name="frist_qc_id" id="frist_qc_id" value="<?php echo set_value('frist_qc_id',encrypt($empt_details['id'])); ?>">
   <input type="hidden" name="action_url" id="action_url" value="<?php echo set_value('action_url',$url); ?>">
    ...
    <div class="row">
    <div class="col-sm-4 form-group" <?php if($url == 'UnableToVerify') { echo 'style="display: none;"'; } ?>>
  ...
  <div class="row">
   ...
   <!-- <div class="col-md-4 col-sm-8 col-xs-4 form-group" <?php if($url == 'UnableToVerify') { echo 'style="display: none;"'; } ?>>
      <label>Employment Type</label>
      <?php
       echo form_dropdown('employment_type',$this->employment_type , set_value('employment_type',$empt_details['empver_employment_type']), 'class="form-control" id="employment_type" readonly');
   ...
   <!-- <div class="col-md-4 col-sm-12 col-xs-4 form-group" <?php if($url == 'UnableToVerify') { echo 'style="display: none;"'; } ?>>
      <label></label>
      <br>
      <label class="radio-inline"><input type="radio" class="rto_clicked" name="employment_type_action" data-val="res_employment_type" value="yes" <?php if(isset($empt_details['employment_type_action'])){ if($empt_details['employment_type_action']== 'yes') {echo "checked='checked'";}} ?>>Yes </label>
      <label class="radio-inline"><input type="radio" class="rto_clicked" name="employment_type_action" data-val="res_employment_type" value="no" <?php if(isset($empt_details['employment_type_action'])){ if($empt_details['employment_type_action']== 'no') {echo "checked='checked'";}} ?>>No</label>
    </div>-->
   <div class="row">
    <div class="col-sm-4 form-group" <?php if($url == 'UnableToVerify') { echo 'style="display: none;"'; } ?>>
      <label >Employed From <span class="error"> *</span> </label>
        <!--<input type="radio" name="calender_display_employee_from" id="calender_display_employee_from" value="calender_value"> : Calender <input type="radio" name="calender_display_employee_from" id="calender_display_employee_from" value="text_value"> : Text -->
  ...
  <div class="row">
    <div class="col-sm-4 form-group" <?php if($url == 'UnableToVerify') { echo 'style="display: none;"'; } ?>>
      ...
      <!-- <input type="radio" name="calender_display_employee_to" id="calender_display_employee_to" value="calender_value"> : Calender <input type="radio" name="calender_display_employee_to" id="calender_display_employee_to" value="text_value"> : Text-->
 ...
 <div class="row">
  ...
  <div class="row"> 
    ...
    <div class="col-sm-4 form-group" <?php if($url == 'UnableToVerify') { echo 'style="display: none;"'; } ?> style="display :none;" id="integrity_disciplinary">
      <label>Reason </label>
...
<div class="row"> 
    ...
    <div class="col-sm-4 form-group" <?php if($url == 'UnableToVerify') { echo 'style="display: none;"'; } ?> style="display :none;" id="exit_formality">
      <label>Reason</label>
  ...
  <div class="row">
    ...
    <div class="col-sm-4 form-group" <?php if($url == 'UnableToVerify') { echo 'style="display: none;"'; } ?> style="display :none;" id="eligible_for_rehire">
      <label >Reason</label>
   ...
   <div class="row"> 
    ...
    <div class="col-md-4 form-group" <?php if($url == 'UnableToVerify') { echo 'style="display: none;"'; } ?>>
  ...
  <div class="row"> 
    <div class="col-sm-2 form-group" <?php if($url == 'UnableToVerify') { echo 'style="display: none;"'; } ?>>
    ...
    <div class="col-sm-3 form-group" <?php if($url == 'UnableToVerify') { echo 'style="display: none;"'; } ?>>
    ...
    if(!empty($details['closuredate']))
     {
        $closuredate =  convert_db_to_display_date($empt_details['closuredate']);
     }
     else{
