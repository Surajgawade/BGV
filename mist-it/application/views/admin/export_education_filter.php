      ...
      <div class="row">
        <div class="col-sm-12 col-md-12">
          <div class="box box-primary">
            <?php echo form_open('#', array('name'=>'frm_education_report','id'=>'frm_education_report')); ?>
              <div class="box-body">
                ...
                <div class="col-md-4 col-sm-12 col-xs-4 form-group">
                    ...
                    <?php 
                    echo form_dropdown('university_board', array(), set_value('university_board'), 'class="form-control singleSelect" id="university_board"');
                  ...
                  <div class="col-md-4 col-sm-12 col-xs-4 form-group">
                    ...
                    <?php 
                    echo form_dropdown('qualification', array(), set_value('qualification'), 'class="form-control singleSelect" id="qualification"');
                ...
                <div class="col-md-4 col-sm-12 col-xs-4 form-group">
                  ...
                  <input type="text" name="res_mode_of_verification" id="res_mode_of_verification" value="<?php echo set_value('res_mode_of_verification');?>" class="form-control">
...
$(document).ready(function(){
  ...
  $('#frm_education_report').validate({ 
    ...
    {      
        $.ajax({
            url : '<?php echo ADMIN_SITE_URL.'reports/education_export'; ?>',
