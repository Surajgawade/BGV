      ...
      <div class="row">
        <div class="col-sm-12 col-md-12">
          <div class="box box-primary">
            <?php echo form_open('#', array('name'=>'frm_drug_report','id'=>'frm_drug_report')); ?>
              <div class="box-body">
                ...
                <div class="col-md-4 col-sm-8 col-xs-4 form-group">
                  ...
                  <input type="text" name="drug_test_code" id="drug_test_code" value="<?php echo set_value('drug_test_code'); ?>" class="form-control">
                ...
                <div class="col-md-4 col-sm-12 col-xs-4 form-group">
                  ...
                  <?php
                   echo form_dropdown('mode_of_verification', $this->mode_of_verification, set_value('mode_of_verification'), 'class="form-control" id="mode_of_verification"');
...
$(document).ready(function(){
  ...
  $('#frm_drug_report').validate({ 
    ...
    {      
        $.ajax({
            url : '<?php echo ADMIN_SITE_URL.'reports/narcver_export'; ?>',
