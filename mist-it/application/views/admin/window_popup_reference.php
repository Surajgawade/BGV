              ...
              <div class="box-header">
                <div class="box-body">
                  <table id="tbl_datatable" class="table table-bordered table-hover">
                    <thead><tr>
                      <th>Sr No.</th><th>Client Name</th><th>Entity</th><th>Package</th><th>Client Ref No</th><th><?php echo REFNO; ?></th><th>Candidate Name</th><th>Received Date</th><th>Component Ref No</th><th>Component Initiation Date</th><th>Name of Reference</th><th>Designation</th><th>Contact Number</th><th>Email ID</th><th>Mode of verification</th><th>verification Status</th><th>Remarks</th><th>QC Status</th><th>TAT Status</th><th>Check Closure Date</th><th>Last Activity</th>
                      </tr>
                    </thead>
                      <?php
                      $x = 1;
                      foreach ($lists as $key => $list) {
                        echo "<tr>";
                          ...
                          echo "<td>".$list['reference_com_ref']."</td>";
                          echo "<td>".$list['iniated_date']."</td>";
                          echo "<td>".$list['name_of_reference']."</td>";
