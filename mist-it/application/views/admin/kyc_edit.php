...
<div class="box-header">
  <div style="float: right;">
    ...
    <button class="btn btn-default btn-sm" data-accessUrl="<?= ADMIN_SITE_URL.'court_verificatiion/delete/'.encrypt($selected_data['id']); ?>"><i class="fa fa-trash"></i> Delete</button>
  </div>
</div>
<div class="box-body">
  <?php echo form_open_multipart('#', array('name'=>'frm_identity_update','id'=>'frm_identity_update')); ?>
    <div class="box-body">
      ...
      <div class="col-md-4 col-sm-12 col-xs-4 form-group">
        ...
        <input type="text" name="KYCRefNumber" id="KYCRefNumber" readonly="readonly" value="<?php echo set_value('KYCRefNumber',$selected_data['kyc_ref_no']); ?>" class="form-control">
