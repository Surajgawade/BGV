              ...
              <div class="box-header">
                <div class="box-body">
                  ...
                  <table id="tbl_datatable" class="table table-bordered table-hover">
                    <thead><tr>
                      <th>Sr No.</th><th>Case Received Date</th><th>Client Name</th><th>Entity</th><th>Package</th><th>Candidate Name</th><th>Client Ref No</th><th><?php echo REFNO; ?></th><th>Status</th><th>Closure Date</th><th>Due Date</th><th>TAT Status</th>
                      </tr>
                    </thead>
                      <?php
                      $x = 1;
                      foreach ($lists as $key => $value) {
                        echo "<tr>";
                          ...
                          echo "<td>".$value['overallclosuredate']."</td>";
