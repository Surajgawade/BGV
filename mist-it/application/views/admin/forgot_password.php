						...
						<input class="form-control" type="text" name="code" id="code" placeholder="Enter Code">
                            ...
                            <div class="form-group m-t-10 mb-0 row">
                                <div class="col-12 m-t-20">
                                    <a href="<?php echo ADMIN_SITE_URL.'login'; ?>" class="text-muted"><i class="mdi mdi-lock"></i>Login</a>
                                </div>
                            </div>
                        </form>
                    </div>
...
$(document).ready(function(){
    $('.refreshCaptcha').on('click', function(){
        $.get('<?php echo ADMIN_SITE_URL.'login/refresh_captcha'; ?>', function(data){
            $('#captImg').html(data);
        });
    });
});
