    ...
    <tbody>
      <?php
        ...
        foreach ($insuff_details as $insuff_detail)
        {
          ...
          echo  "<td>".$Raised."</td>";
          echo  "<td>".$insuff_detail['insff_reason']."</td>";
          ...
          $access_insuff = ($this->permission['access_address_list_insuff_edit']) ? $insuff_detail['id'] : '';
          $access_insuff_clear = ($this->permission['access_address_list_insuff_clear']) ? $insuff_detail['id'] : '';
          $access_insuff_delete = ($this->permission['access_address_list_insuff_delete']) ? $insuff_detail['id'] : '';
