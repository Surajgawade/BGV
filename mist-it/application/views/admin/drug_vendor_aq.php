    ...
    <div class="row">
         <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Drugs/Narcotics - Drugs AQ</h4>
                  <ol class="breadcrumb">
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>dashboard"><?php echo SHORT_CO_NAME ?></a></li>
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>drugs_narcotics">Drugs/Narcotics</a></li>
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>drugs_narcotics/approval_queue">Drugs AQ</a></li>
        ...
        <div class="col-12">
          ...
          <div class="card m-b-20">
            <div class="card-body">
              ...
              <?php echo form_dropdown('cases_assgin', $assigned_option, set_value('cases_assgin'), 'class="custom-select" id="cases_assgin"');?>
              </div>
...
<div id="showvendorModel" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-lg" >
    ...
    <div class="modal-content">
      ...
      <input type="hidden" name="drugs_id" id = "drugs_id"  class = "drugs_id" value="">
     ...
     <div class="showbutton1" style="display: none;">
      ...
      ="<?= ADMIN_SITE_URL.'activity_log/activity_log_view_vendor_form/8/' ?>" data-toggle="modal" id="activityModelClk1" type="button" >Approve</button>
  ...
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="row">
            <input type="hidden" name="component_type" id="component_type" value="7">
...
<div id="addAddResultModel" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-lg" >
    ...
    <div class="modal-content">
      ...
      <input type="hidden" id="drug_narcotis_id" name="drug_narcotis_id" value="<?php echo set_value('drugs_narcotics_id'); ?>">
      <input type="hidden" id="clientid"  name="clientid" value="<?php echo set_value('clientid'); ?>">
    

      <input type="hidden" id="drug_narcotis_result_id" name="drug_narcotis_result_id" value="<?php echo set_value('drugs_result_id'); ?>">
...
$(document).ready(function() {
  ...
  var oTable =  $('#example').DataTable( {
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: "<?php echo ADMIN_SITE_URL.'drugs_narcotics/view_approval_queue'; ?>",
        ...
        "columns":[{'data' :'checkbox'},{'data' :'id'},{"data":"drug_com_ref"},{"data":"clientname"},{"data":"entity_name"},{"data":"package_name"},{'data' :'vendor_name'},{'data' :'drug_test_code'},{'data' :'city'},{'data' :'pincode'},{'data' :'state'},{'data' :'allocated_by'},{"data":"allocated_on"}]
  });
...
$(document).on('click', '#btn_assign', function(){
    ...
    { 
        $.ajax({
          type:'POST',
          url:'<?php echo ADMIN_SITE_URL.'drugs_narcotics/drug_final_assigning/' ?>',
...
$(document).on('click','#activityModelClk1',function() {
 ...
 var drugs_result_id  = $('#drugs_result_id1').val();


 document.getElementById("drug_narcotis_id").value = component_id; 
 ...
 document.getElementById("drug_narcotis_result_id").value = drugs_result_id; 
  ...
  $('#frm_verificarion_result').validate({
    ...
    { 
      ...
      $.ajax({
        ...
        $.ajax({
          url : '<?php echo ADMIN_SITE_URL.'drugs_narcotics/drugs_closure/' ?>',
