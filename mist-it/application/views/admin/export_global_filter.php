      ...
      <div class="row">
        <div class="col-sm-12 col-md-12">
          <div class="box box-primary">
            <?php echo form_open('#', array('name'=>'frm_global_report','id'=>'frm_global_report')); ?>
              <div class="box-body">
...
$(document).ready(function(){
  ...
  $('#frm_global_report').validate({ 
    ...
    {      
        $.ajax({
            url : '<?php echo ADMIN_SITE_URL.'reports/global_export'; ?>',
