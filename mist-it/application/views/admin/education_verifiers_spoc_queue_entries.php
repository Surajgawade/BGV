              ...
              <div class="col-12">
                <div class="card m-b-20">
                  <div class="card-body">
                    ...
                    <br>
                    <table id="tbl_vendor_verifiers_spoc_queue" class="table table-bordered  nowrap"  style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                      <thead>
                        <tr>
                          <th>#</th>
                          <th>#</th>
          ...
          <div class="row">
            <div class="col-sm-6 form-group">
             <label>Stamp Status</label>
               <?php
                echo form_dropdown('cases_assgin_stamp_bulk', $assigned_option, set_value('cases_assgin_stamp_bulk'), 'class="form-control" id="cases_assgin_stamp_bulk"');?>
            </div>
...
$(function ()  {
  ...
  var table =  $('#tbl_vendor_verifiers_spoc_queue').DataTable( {
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: "<?php echo ADMIN_SITE_URL.'education/education_spoc_verifiers_pending_details'; ?>",
   ...
   $('#tbl_vendor_verifiers_spoc_queue tbody').on('click', 'td.details-control', function () {
  ...
  $('#tbl_vendor_verifiers_spoc_queue tbody').on('change', 'input[type="checkbox"]', function(){
 ...
 $(".dt-checkboxes-select-all").click(function () {
     $('#tbl_vendor_verifiers_spoc_queue').find('input[type="checkbox"]').trigger('click');

});

 $('#tbl_vendor_verifiers_spoc_queue tbody').on( 'click', 'tr', function () {
  ...
  $('#tbl_vendor_verifiers_spoc_queue').on('click', 'tbody td, thead th:first-child', function(e){
