                    ...
                    <table id="tbl_vendor_insuff" class="table table-bordered  nowrap"  style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                      ...
                      <?php
                        ...
                        foreach ($vendor_executive_list as $key => $value) {
                           $html_view .= "<tr id = ".$value['credit_report_id']." url = ".ADMIN_SITE_URL."credit_report/check_insuff_already_raised/".$value['credit_report_id']." >";
                            $html_view .= "<td>".$i."</td>";
                            ...
                            $html_view .= "<td>".$value['credit_report_com_ref']."</td>";
