                    ...
                    if($attachments)
                        {
                            ...
                            { 
                                ...
                                echo '<a href="javascript:;" onClick="myOpenWindow('.$url.$actual_file.','.$myWin.','.$attribute.'); return false"> <img src='.$url_attachment.$actual_file.' height = "75px" width = "75px" ><br>'.$attachments[$i]['file_name'].'</a>&nbsp;&nbsp;&nbsp;&nbsp;';
