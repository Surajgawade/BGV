<div class="modal-body">
  ...
  <div class="row">
    ...
    <div class="col-md-4 col-sm-12 col-xs-4 form-group">
      ...
      <input type="text" name="closuredate" id="closuredate" value="<?php echo set_value('closuredate',convert_db_to_display_date($details['remarks']));?>" class="form-control myDatepicker" placeholder='DD-MM-YYYY'>
