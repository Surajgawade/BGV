    ...
    <tbody>
      <?php
        ...
        foreach ($insuff_details as $insuff_detail)
        {
          ...
          $access_insuff = ($this->permission['access_education_list_insuff_edit']) ? $insuff_detail['id'] : '';
          $access_insuff_clear = ($this->permission['access_education_list_insuff_clear']) ? $insuff_detail['id'] : '';
          $access_insuff_delete = ($this->permission['access_education_list_insuff_delete']) ? $insuff_detail['id'] : '';
