        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
              ...
              <?php echo form_dropdown('cases_assgin', $assigned_option, set_value('cases_assgin'), 'class="form-control" id="cases_assgin"');?>
              </div>
...
$(document).on('click', '#btn_assign', function(){
    ...
    { 
        $.ajax({
          type:'POST',
          url:'<?php echo ADMIN_SITE_URL.'reference_verificatiion/reference_final_assigning/' ?>',
