      ...
      <div class="row">
         <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Address - Assign Address</h4>
                  <ol class="breadcrumb">
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>dashboard"><?php echo SHORT_CO_NAME ?></a></li>
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>address">Address</a></li>
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>assign_add">Assign Address</a></li>
                     <li class="breadcrumb-item active">List View</li>
                  </ol>
            
                  <div class="state-information d-none d-sm-block">
                    <ol class="breadcrumb">
                      <?php $access_export = ($this->permission['access_address_list_export']) ? '#myModalExport'  : ''; ?>
...
<div id="myModalCasesAssignvendor" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
...
$(document).ready(function() {
  ...
  var oTable =  $('#tbl_datatable_assign').DataTable( {
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: "<?php echo ADMIN_SITE_URL.'assign_add/address_view_datatable_assign'; ?>",
        ...
        "columns":[{'data' :'checkbox'},{'data' :'ClientRefNumber'},{"data":"add_com_ref"},{"data":"iniated_date"},{"data":"mode_of_verification"},{"data":"clientname"},{'data' :'CandidateName'},{'data' :'vendor_name'},{'data' :'status_value'},{'data' :'address'},{'data' :'state'},{'data' :'city'},{"data":"executive_name"},{'data':'first_qc_approve'},{'data':'tat_status'},{'data':'check_closure_date'},{'data':"last_activity_date"}]
  });
  ...
  $('#btn_assign_action_vendor').on('click', function(e){
    ...
    if(vendor_list != "0" && select_one != "")
    {
        ...
        $.ajax({
          type:'POST',
          url:'<?php echo ADMIN_SITE_URL.'address/assign_to_vendor/' ?>',
