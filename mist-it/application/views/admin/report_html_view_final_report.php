...
?>
       ...
       <ol class="breadcrumb" style="margin-top: -58px;margin-left: 374px;">
          ...
          <li> 
           ...
           <!-- <button type='button' class='btn btn-success' type='button' name='brn_first_qc_reject' id='brn_first_qc_reject'>Approve & Send</button>-->
            <button type='button' class='btn btn-info' type='button' name='rearrange_images' id='rearrange_images'>Order Images</button>
...
<br>
 ...
 <input type="hidden" name="ClientRefNumber" id="ClientRefNumber"  value = "<?php echo $ClientRefNumber ?>">
      ...
      <div class="col-xs-12 col-md-12">
        <html>
          <head>
            ...
            <style> table { margin-top: 15px; } table, td{ border: 2px solid #b7b1b145; height: 35px; color: #000; } .form-control { border: 0px none; }</style> 
          </head>
          <body>
            ...
            <div style="float: right;margin: 15px"> <img src="<?= SITE_IMAGES_URL; ?>logo.jpeg" height="50" width="200" alt="logo"></div>
            <div class="clearfix"></div>
            <hr style="border-top: 5px solid #594a8e;margin-right:22px">

            <table width="97%" cellpadding="5" cellspacing="pixels">

              <tr>
                <td style="background-color: #0000000f;"><b>CLIENT NAME</b></td>
                <td colspan="3"> <input type="text" name="" class="form-control" value="<?= $candidate_details['clientname'] ?>" > </td>
              </tr>
              <tr>
                <td style="background-color: #0000000f;"><b>CANDIDATE NAME</b></td>
                <td colspan="3"> <input type="text" name="" class="form-control" value="<?= $candidate_details['CandidateName'] ?>" > </td>
              </tr>
              <tr>
                <td style="background-color: #0000000f;"><b><?php echo COMPANYREFNOCAP ?></b></td>
                <td> <input type="text" name=""  class="form-control" value="<?= strtoupper($candidate_details['cmp_ref_no']) ?>"> </td>
                <td style="background-color: #0000000f;"><b>CLIENT REF NO</b></td>
                <td width="140px"> <input type="text" class="form-control" name="" value="<?= strtoupper($candidate_details['ClientRefNumber']) ?>"></td>
              </tr>
            <!--  <tr>
                <td style="background-color: #0000000f;"><b> GENDER</b></td>
                <td> <input type="text" name="" class="form-control" value="<?= $candidate_details['gender'] ?>"> </td>
               
              </tr>-->
              <tr>
                <td style="background-color: #0000000f;"><b> DATE INITIATED</b></td>
              ...
              <tr>
                ...
                <td style="background-color: #0000000f;"><b> DATE OF COMPLETION</b></td>
                <td width="140px"> <input type="text" class="form-control" name="" value="<?= $overallclosuredate ?>"></td>
                <td style="background-color: #0000000f;"><b> REPORT STATUS</b></td>
            ...
            <!--<table width="97%" cellpadding="5" cellspacing="pixels">
              <tr>
                <td colspan="4" style="background-color: #0000000f;" style="text-align: center;height: 35px;"><b> CLASSIFICATION OF REPORT STATUS</b></td>
              </tr>
            ...
            <table width="97%" cellpadding="5" cellspacing="pixels">
              <tr>
                <td style="background-color: #0000000f; text-align: center;height: 35px;"><b>EXECUTIVE SUMMARY</b></td>
              </tr>
            </table>

            <table width="97%" cellpadding="5" cellspacing="pixels">
              <tr>
                <td style="background-color: #0000000f; text-align: center;"><b> TYPE OF CHECK</b></td>
                <td style="background-color: #0000000f; text-align: center;"><b> BRIEF DETAILS</b></td>
                <td style="background-color: #0000000f; text-align: center;"><b> STATUS</b></td>
              </tr>
              <?php 
              ...
              foreach ($employment as $key => $value)  {
                ...
                echo "<tr><td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>".$component_name['empver'] .$counter."</b></td>";
              ...
              foreach ($address as $key => $value)  {
                ...
                $value = array_map('ucwords', $value);
                $counter = ($key == 0) ? ''  : $key+1;
                echo "<tr><td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>".$component_name['addrver'].$counter."</b></td>";
              ...
              foreach ($education as $key => $value)  {
                $value = array_map('ucwords', $value);
                $counter = ($key == 0) ? ''  : $key+1;
                echo "<tr><td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>".$component_name['eduver'].$counter."</b></td>";
              ...
              foreach ($reference as $key => $value)  {
                $value = array_map('ucwords', $value);
                $counter = ($key == 0) ? ''  : $key+1;
                echo "<tr><td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>".$component_name['refver'].$counter."</b></td>";
              ...
              foreach ($court as $key => $value)  {
                ...
                echo "<tr><td style='background-color: #0000000f;' style='border-right: 2px solid;'><b> ".$component_name['courtver'].$counter."</b></td>";
                echo "<td><input type='text' name='' class='form-control' value='".$full_address."' > </td>";
                 if($value['verfstatus'] == "Major Discrepancy")
                {
                echo "<td><input type='text' name=''  style='background-color: #ff2300eb;' class='form-control' value='".$value['verfstatus']."'></td></tr>";
              ...
              foreach ($global_db as $key => $value)  {
                ...
                echo "<tr><td style='background-color: #0000000f;' style='border-right: 2px solid;'><b> ".$component_name['globdbver'].$counter."</b></td>";
                echo "<td><input type='text' name='' class='form-control' value='".$full_address."' > </td>";
                  if($value['verfstatus'] == "Major Discrepancy")
                {
                echo "<td><input type='text' name=''  style='background-color: #ff2300eb;' class='form-control' value='".$value['verfstatus']."'></td></tr>";
              ...
              foreach ($drug as $key => $value)  {
                $value = array_map('ucwords', $value);
                $counter = ($key == 0) ? ''  : $key+1;
                echo "<tr><td style='background-color: #0000000f;' style='border-right: 2px solid;'><b> ".$component_name['narcver'].$counter."</b></td>";
              ...
              foreach ($pcc as $key => $value)  {
                ...
                echo "<tr><td style='background-color: #0000000f;' style='border-right: 2px solid;'><b> ".$component_name['crimver'].$counter."</b></td>";
                echo "<td> <input type='text' name='' class='form-control' value='".$full_address."' > </td>";
                  if($value['verfstatus'] == "Major Discrepancy")
                {
                echo "<td><input type='text' name=''  style='background-color: #ff2300eb;' class='form-control' value='".$value['verfstatus']."'></td></tr>";
              ...
              foreach ($identity as $key => $value)  {
                $value = array_map('ucwords', $value);
                $counter = ($key == 0) ? ''  : $key+1;
                echo "<tr><td style='background-color: #0000000f;' style='border-right: 2px solid;'><b> ".$component_name['identity'].$counter."</b></td>";
              ...
              foreach ($credit_report  as $key => $value)  {
                ...
                echo "<tr><td style='background-color: #0000000f;' style='border-right: 2px solid;'><b> ".$component_name['cbrver'].$counter."</b></td>";
                echo "<td> <input type='text' name='' class='form-control' value='".$value['doc_submited']."' > </td>";
                  if($value['verfstatus'] == "Major Discrepancy")
                {
                echo "<td><input type='text' name=''  style='background-color: #ff2300eb;' class='form-control' value='".$value['verfstatus']."'></td></tr>";
            ...
            <table cellpadding="8" style="text-align: center; margin-right: 22px">
            <tr>
              <td width="7%"><img src="<?= SITE_IMAGES_URL ?>write.png" width="20" height="20" ></td>
              <td width="15%" bgcolor="#10840C" >GREEN</td>
              <td width="78%">Details provided by the candidate are correct / matching.</td>
            </tr>
            <tr>
              <td width="7%"><img src="<?= SITE_IMAGES_URL ?>wrong.png" width="20" height="20"></td>
            ...
            <tr>
              <td width="7%"> <img src="<?= SITE_IMAGES_URL ?>exclamation.png" width="20" height="20" ></td>
            ...
            <?php
              foreach ($employment as $key => $value)  {
                ...
                echo "<tr>";
                echo "<td style='text-align: center;height: 35px; background-color: #0000000f;'><b>".$component_name['empver']." VERIFICATION ".$counter."</b></td>";
                echo "</tr>";    
                echo "</table>";

                echo "<table width='97%' cellpadding='5' cellspacing='pixels' style='border:2px solid;'>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border:2px solid;'><b> COMPONENTS</b></td>";
                echo "<td style='background-color: #0000000f;' style='border:2px solid;'><b> INFORMATION PROVIDED</b></td>";
                echo "<td style='background-color: #0000000f;' style='border:2px solid;'><b> INFORMATION VERIFIED</b></td>";
                echo "</tr>"; 
                echo "<tr>";
               
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>NAME OF THE COMPANY</b></td>";
                ...
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>EMPLOYEE ID</b></td>";
                ...
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>PERIOD OF EMPLOYMENT<b></td>";
                ...
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;'  style='border-right: 2px solid;'><b>DESIGNATION</b></td>";
                ...
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;'  style='border-right: 2px solid;'><b>REMUNERATION</b></td>";
                ...
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;'  style='border-right: 2px solid;'><b>REPORTING MANAGER</b></td>";
                ...
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>REASON OF LEAVING</b></td>";
                ...
                echo "<table width='97%' cellpadding='5' cellspacing='pixels' style='border:2px solid;'>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border:2px solid;'><b> DETAILS</b></td>";
                echo "<td style='background-color: #0000000f;' style='border:2px solid;'><b> FINDINGS</b></td>";
                echo "</tr>"; 
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>ANY INTEGRITY/DISCIPLINARY ISSUES</b></td>";
                echo "<td><input type='text' name='' class='form-control' value='".$info_integrity_disciplinary_issue."'></td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>EXIT FORMALITIES COMPLETED</b></td>";
                echo "<td><input type='text' name='' class='form-control' value='".$info_exitformalities."'></td>";
                echo "</tr>";
                echo "<tr>";
             /*   echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>ADDITIONAL COMMENTS";
                ...
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>THE COMPANY IS REGISTERED  IN  MCA?</b></td>";
                echo "<td><input type='text' name='' class='form-control' value='".$mcaregn."'></td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>DOMAIN NAME</b></td>";
                echo "<td><input type='text' name='' class='form-control' value='".$domainname."'></td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>THE COMPANY IS LISTED IN JUSTDIAL AND INTERNET SEARCHES?</b></td>";
                echo "<td><input type='text' name='' class='form-control' value='".$justdialwebcheck."'></td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>IS IT FAMILY OWNED  BUSSINESS?</b></td>";
                echo "<td><input type='text' name='' class='form-control' value='".$fmlyowned."'></td>";
                echo "</tr>";

                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>VERIFIED BY</b></td>";
                echo "<td><input type='text' name='' class='form-control' value='".$verifiers_details."'></td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>MODE OF VERIFICATION</b></td>";
                echo "<td><input type='text' name='' class='form-control' value='".$modeofverification."'></td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>REMARKS</b></td>";
              ...
              //  <button type='button' class='btn btn-warning' type='button' name='brn_first_qc_reject' id='brn_first_qc_reject'>Reject</button>";
                ...
                if(!empty($employment_vendor_attachments))
                {
                    ...
                    foreach ($employment_vendor_attachments as $key => $vendor_attachments) {
                    
                         echo "<div class='col-md-4 order_by_image'>";
                          echo "<div class='thumbnail'>";
                           $url  = "'".SITE_URL.EMPLOYMENT.'vendor_file'.'/'.$vendor_attachments."'";
                           $myWin  = "'"."myWin"."'";
                           $attribute  = "'"."height=250,width=480"."'";
                            echo '<a href="javascript:;" ondblClick="myOpenWindow('.$url.','.$myWin.','.$attribute.'); return false"><img src="'.SITE_URL.EMPLOYMENT.'vendor_file'.'/'.$vendor_attachments.'" class="img-rounded" alt="attachments missign" width="304" height="236"></a> ';
                          echo "</div>";
                         echo "</div>";
                    }
              ...
              foreach ($address as $key => $value)  {
               ...
               // $verified = ($period_of_stay == $res_period_of_stay) ? 'verified' : $res_period_of_stay;
                ...
                echo "<table width='97%' cellpadding='5' cellspacing='pixels'>";
                echo "<tr>";
                echo "<td style='text-align: center;height: 35px; background-color: #0000000f;'><b>".$component_name['addrver']." VERIFICATION ".$counter."</b></td>";
                echo "</tr>";    
                echo "</table>";
                ...
                echo "</tr>"; 
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>ADDRESS</b></td>";
                echo "<td>".$full_address." </td>";
                echo "<td><input type='text' name='res_full_address' class='form-control' value='".$verified_address_status."' ></td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>PERIOD OF STAY</b></td>";
                ...
                echo "</tr>"; 
                echo "<tr>";
               // echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>ADDITIONAL COMMENTS</b></td>";
               ...
               // <button type='button' class='btn btn-warning' type='button' name='brn_first_qc_reject' id='brn_first_qc_reject'>Reject</button>";
                ...
                if(!empty($address_vendor_attachments))
                {
                    ...
                    foreach ($address_vendor_attachments as $key => $vendor_attachments) {
                    
                         echo "<div class='col-md-4 order_by_image'>";
                          echo "<div class='thumbnail'>";
                           $url  = "'".SITE_URL.ADDRESS.'vendor_file'.'/'.$vendor_attachments."'";
                           $myWin  = "'"."myWin"."'";
                           $attribute  = "'"."height=250,width=480"."'";
                            echo '<a href="javascript:;" ondblClick="myOpenWindow('.$url.','.$myWin.','.$attribute.'); return false"><img src="'.SITE_URL.ADDRESS.'vendor_file'.'/'.$vendor_attachments.'" class="img-rounded" alt="attachments missign" width="304" height="236"></a> ';
                          echo "</div>";
                         echo "</div>";
                    }
              ...
              foreach ($education as $key => $value) {
                ...
                echo "<table width='97%' cellpadding='5' cellspacing='pixels'>";
                echo "<tr>";
                echo "<td style='text-align: center;height: 35px; background-color: #0000000f;'><b>".$component_name['eduver']." VERIFICATION ".$counter."</b></td>";
                echo "</tr>";    
                echo "</table>";
                ...
                echo "</tr>"; 
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>NAME OF THE COLLEGE / UNIVERSITY</b></td>";
                echo "<td>".$school_college_univerity."</td>";
                echo "<td><input type='text' name='res_school_college' class='form-control' value='".$verified."' ></td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>QUALIFICATION ATTAINED</b></td>";
                ...
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>YEAR OF PASSING</b></td>";
                ...
                echo "</tr>"; 
                echo "<tr>";
              //  echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>ADDITIONAL COMMENTS (IF ANY)</b></td>";
              //  echo "<td ><input type='text' name='res_remarks' class='form-control' value='".$value['res_remarks']."'></td>";
               ...
               // <button type='button' class='btn btn-warning' type='button' name='brn_first_qc_reject' id='brn_first_qc_reject'>Reject</button>";
                ...
                $university_attachments = ($value['university_attachments'] != NULL && $value['university_attachments'] != '') ?  explode('||', $value['university_attachments']) : '';
                ...
                if(!empty($university_attachments))
                {
                    ...
                    echo "<div class='col-xs-12 col-md-12'>";
                    echo "<ul class='sortable'>";
                    foreach ($university_attachments as $key => $university_attachment) {
                      $attach = explode('/', $university_attachment);

                        echo "<div class='col-md-4 order_by_image' id='item-education-".$value['education_id']."-".$attach[0]."'>";
                          echo "<div class='thumbnail'>";
                           $url  = "'".SITE_URL.UNIVERSITY_PIC.$attach[1]."'";
                           $myWin  = "'"."myWin"."'";
                           $attribute  = "'"."height=250,width=480"."'";
                            echo '<a href="javascript:;" ondblClick="myOpenWindow('.$url.','.$myWin.','.$attribute.'); return false"><img src="'.SITE_URL.UNIVERSITY_PIC.$attach[1].'" class="img-rounded" alt="attachments missign" width="304" height="236"></a> ';
                          echo "</div>";
                        echo "</div>";
                    }
                    echo "</ul>";
                ...
                if(!empty($education_vendor_attachments))
                {
                    ...
                    foreach ($education_vendor_attachments as $key => $vendor_attachments) {
                    
                         echo "<div class='col-md-4 order_by_image'>";
                          echo "<div class='thumbnail'>";
                           $url  = "'".SITE_URL.EDUCATION.'vendor_file'.'/'.$vendor_attachments."'";
                           $myWin  = "'"."myWin"."'";
                           $attribute  = "'"."height=250,width=480"."'";
                            echo '<a href="javascript:;" ondblClick="myOpenWindow('.$url.','.$myWin.','.$attribute.'); return false"><img src="'.SITE_URL.EDUCATION.'vendor_file'.'/'.$vendor_attachments.'" class="img-rounded" alt="attachments missign" width="304" height="236"></a> ';
                          echo "</div>";
                         echo "</div>";
                    }
              ...
              foreach ($reference as $key => $value)  {
                ...
                echo "<table width='97%' cellpadding='5' cellspacing='pixels'>";
                echo "<tr>";
                echo "<td style='text-align: center;height: 35px; background-color: #0000000f;'><b>".$component_name['refver']." VERIFICATION ".$counter."</b></td>";
                echo "</tr>";    
                echo "</table>";

                echo "<table width='97%' cellpadding='5' cellspacing='pixels' style='border:2px solid;'>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border:2px solid;'><b> PARTICULARS</b></td>";
                echo "<td style='background-color: #0000000f;' style='border:2px solid;'><b> VERIFIED INFORMATION</b></td>";
                echo "</tr>"; 
                echo "<tr>";
                echo "<td  style='background-color: #0000000f;' style='border-right: 2px solid;'><b> REFERENCE NAME</b></td>";
                ...
                echo "</tr>";
                echo "<tr>";
                echo "<td  style='background-color: #0000000f;' style='border-right: 2px solid;'><b>ABILITY TO HANDLE PRESSURE</b></td>";
                echo "<td style='text-align: left;padding-left: 10px;'>".$handle_pressure_value."</td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td  style='background-color: #0000000f;' style='border-right: 2px solid;'><b>ATTENDANCE/PUNCTUALITY</b></td>";
                echo "<td style='text-align: left;padding-left: 10px;'>".$attendance_value."</td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td  style='background-color: #0000000f;' style='border-right: 2px solid;'><b>INTEGRITY, CHARACTER & HONESTY</b></td>";
                echo "<td style='text-align: left;padding-left: 10px;'>".$integrity_value."</td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td  style='background-color: #0000000f;' style='border-right: 2px solid;'><b>LEADERSHIP SKILLS</b></td>";
                echo "<td style='text-align: left;padding-left: 10px;'>".$leadership_skills_value."</td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td  style='background-color: #0000000f;' style='border-right: 2px solid;'><b>RESPONSIBILITIES & DUTIES</b></td>";
                echo "<td style='text-align: left;padding-left: 10px;'>".$responsibilities_value."</td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td  style='background-color: #0000000f;' style='border-right: 2px solid;'><b>SPECIFIC ACHIEVEMENTS</b></td>";
                echo "<td style='text-align: left;padding-left: 10px;'>".$achievements_value."</td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td  style='background-color: #0000000f;' style='border-right: 2px solid;'><b>STRENGTHS</b></td>";
                echo "<td style='text-align: left;padding-left: 10px;'>".$strengths_value."</td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td  style='background-color: #0000000f;' style='border-right: 2px solid;'><b>WEAKNESSES</b></td>";
                echo "<td style='text-align: left;padding-left: 10px;'>".$weakness_value."</td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td  style='background-color: #0000000f;' style='border-right: 2px solid;'><b>TEAM PLAYER</b></td>";
                echo "<td style='text-align: left;padding-left: 10px;'>".$team_player_value."</td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td  style='background-color: #0000000f;' style='border-right: 2px solid;'><b>OVERALL PERFORMANCE</b></td>";
              ...
              foreach ($court as $key => $value)  {
               ...
               // $value = array_map('ucwords', $value);
                ...
                echo "<table width='97%' cellpadding='5' cellspacing='pixels'>";
                echo "<tr>";
                echo "<td style='text-align: center;height: 35px; background-color: #0000000f;'><b>".$component_name['courtver']." VERIFICATION ".$counter."</b></td>";
                echo "</tr>";    
                echo "</table>";
                ...
                echo "</tr>";
               // echo "<tr>";
               // echo "<td  style='background-color: #0000000f;' style='border-right: 2px solid;'><b>CRIMINAL RECORD STATUS</b></td>";
               ...
               // echo "<button type='button' class='btn btn-info' type='button' name='brn_first_qc_approve' id='brn_first_qc_approve'>Approve</button>
                ...
                if(!empty($court_vendor_attachments))
                {
                    ...
                    foreach ($court_vendor_attachments as $key => $vendor_attachments) {
                    
                         echo "<div class='col-md-4 order_by_image'>";
                          echo "<div class='thumbnail'>";
                           $url  = "'".SITE_URL.COURT_VERIFICATION.'vendor_file'.'/'.$vendor_attachments."'";
                           $myWin  = "'"."myWin"."'";
                           $attribute  = "'"."height=250,width=480"."'";
                            echo '<a href="javascript:;" ondblClick="myOpenWindow('.$url.','.$myWin.','.$attribute.'); return false"><img src="'.SITE_URL.COURT_VERIFICATION.'vendor_file'.'/'.$vendor_attachments.'" class="img-rounded" alt="attachments missign" width="304" height="236"></a> ';
                          echo "</div>";
                         echo "</div>";
                    }
              ...
              foreach ($global_db as $key => $value)  {
                ...
                echo "<table width='97%' cellpadding='5' cellspacing='pixels'>";
                echo "<tr>";
                echo "<td style='text-align: center;height: 35px; background-color: #0000000f;'><b>".$component_name['globdbver']." VERIFICATION ".$counter."</b></td>";
                echo "</tr>";    
                echo "</table>";
               ...
               /// echo "<button type='button' class='btn btn-info' type='button' name='brn_first_qc_approve' id='brn_first_qc_approve'>Approve</button>
                ...
                if(!empty($global_vendor_attachments))
                {
                    ...
                    foreach ($global_vendor_attachments as $key => $vendor_attachments) {
                    
                         echo "<div class='col-md-4 order_by_image'>";
                          echo "<div class='thumbnail'>";
                           $url  = "'".SITE_URL.GLOBAL_DB.'vendor_file'.'/'.$vendor_attachments."'";
                           $myWin  = "'"."myWin"."'";
                           $attribute  = "'"."height=250,width=480"."'";
                            echo '<a href="javascript:;" ondblClick="myOpenWindow('.$url.','.$myWin.','.$attribute.'); return false"><img src="'.SITE_URL.GLOBAL_DB.'vendor_file'.'/'.$vendor_attachments.'" class="img-rounded" alt="attachments missign" width="304" height="236"></a> ';
                          echo "</div>";
                         echo "</div>";
                    }
              ...
              foreach ($drug as $key => $value)  {
                ...
                echo "<table width='97%' cellpadding='5' cellspacing='pixels'>";
                echo "<tr>";
                echo "<td style='text-align: center;height: 35px; 'background-color: #0000000f;'><b>".$component_name['narcver']." VERIFICATION ".$counter."</b></td>";
                echo "</tr>";    
                echo "</table>";

                echo "<table width='97%' cellpadding='5' cellspacing='pixels' style='border:2px solid;'>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border:2px solid;'><b> 5 DRUG PANEL</b></td>";
                echo "<td style='background-color: #0000000f;' style='border:2px solid;'><b> STATUS</b></td>";
                echo "</tr>"; 
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b> AMPHETAMINE SCREEN, URINE</b></td>";
                echo "<td><input type='text' name='' class='form-control' value='".$amphetamine_screen."' ></td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b> CANNABINOIDS SCREEN, URINE</b></td>";
                echo "<td><input type='text' name='' class='form-control' value='".$cannabinoids_screen."' ></td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;'  style='border-right: 2px solid;'><b>  COCAINE SCREEN, URINE</b></td>";
                echo "<td><input type='text' name='' class='form-control' value='".$cocaine_screen."' ></td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;' ><b>  OPIATES SCREEN, URINE</b></td>";
                echo "<td><input type='text' name='' class='form-control' value='".$opiates_screen."' ></td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;' ><b> PHENCYCLIDINE SCREEN, URINE</b></td>";
              ...
              foreach ($pcc as $key => $value)  {
                ...
                echo "<table width='97%' cellpadding='5' cellspacing='pixels' >";
                echo "<tr>";
                echo "<td style='text-align: center;height: 35px; 'background-color: #0000000f;'><b>".$component_name['crimver']." VERIFICATION ".$counter."</b></td>";
                echo "</tr>";    
                echo "</table>";
                ...
                echo "</tr>"; 
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>DATE OF VISIT POLICE STATION</b></td>";
                ...
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>NAME AND DESIGNATION OF THE POLICE OFFICER</b></td>";
                echo "<td><input type='text' name='' class='form-control' value='".$name_designation_police."' ></td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>CONTACT NUMBER OF POLICE</b></td>";
                echo "<td><input type='text' name='contact_number_police' class='form-control' value='".$contact_number_police."' ></td>";
                echo "</tr>";
              //  echo "<tr>";
               // echo "<td style='background-color: #0000000f;' style='border-right: 2px solid;'><b>RESULT OF THE POLICE VERIFICATION RECORD</b></td>";
               ...
               // echo "<button type='button' class='btn btn-info' type='button' name='brn_first_qc_approve' id='brn_first_qc_approve'>Approve</button>
                ...
                if(!empty($pcc_vendor_attachments))
                {
                    ...
                    foreach ($pcc_vendor_attachments as $key => $vendor_attachments) {
                    
                         echo "<div class='col-md-4 order_by_image'>";
                          echo "<div class='thumbnail'>";
                           $url  = "'".SITE_URL.PCC.'vendor_file'.'/'.$vendor_attachments."'";
                           $myWin  = "'"."myWin"."'";
                           $attribute  = "'"."height=250,width=480"."'";
                            echo '<a href="javascript:;" ondblClick="myOpenWindow('.$url.','.$myWin.','.$attribute.'); return false"><img src="'.SITE_URL.PCC.'vendor_file'.'/'.$vendor_attachments.'" class="img-rounded" alt="attachments missign" width="304" height="236"></a> ';
                          echo "</div>";
                         echo "</div>";
                    }
              ...
              foreach ($identity as $key => $value)  {
                ...
                echo "<table width='97%' cellpadding='5' cellspacing='pixels'>";
                echo "<tr>";
                echo "<td style='text-align: center;height: 35px; 'background-color: #0000000f;'><b>".$component_name['identity']." VERIFICATION ".$counter."</b></td>";
                echo "</tr>"; 
                ...
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border:2px solid;'><b> DOCUMENT PROVIDED</b></td>";
                ...
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border:2px solid;'><b> MODE OF VERIFICATION</b></td>";
                echo "<td><input type='text' name='' class='form-control' value='".$mode_of_verification."' ></td>";
                echo "</tr>";
                echo "<tr>";
                echo "<td style='background-color: #0000000f;' style='border:2px solid;'><b> REMARKS</b></td>";
                echo "<td style='text-align: left;'>&nbsp;&nbsp;".$remarks."</td>";
               // echo "</tr>";
                ...
                if(!empty($identity_vendor_attachments))
                {
                    ...
                    foreach ($identity_vendor_attachments as $key => $vendor_attachments) {
                    
                         echo "<div class='col-md-4 order_by_image'>";
                          echo "<div class='thumbnail'>";
                           $url  = "'".SITE_URL.IDENTITY.'vendor_file'.'/'.$vendor_attachments."'";
                           $myWin  = "'"."myWin"."'";
                           $attribute  = "'"."height=250,width=480"."'";
                            echo '<a href="javascript:;" ondblClick="myOpenWindow('.$url.','.$myWin.','.$attribute.'); return false"><img src="'.SITE_URL.IDENTITY.'vendor_file'.'/'.$vendor_attachments.'" class="img-rounded" alt="attachments missign" width="304" height="236"></a> ';
                          echo "</div>";
                         echo "</div>";
                    }
              ...
              foreach ($credit_report as $key => $value)  {
                ...
                echo "<table width='97%' cellpadding='5' cellspacing='pixels'>";
                echo "<tr>";
                echo "<td style='text-align: center;height: 35px; 'background-color: #0000000f;'><b>".$component_name['cbrver']." VERIFICATION ".$counter."</b></td>";
                echo "</tr>";    
                echo "</table>";
                ...
                if(!empty($credit_report_vendor_attachments))
                {
                    ...
                    foreach ($credit_report_vendor_attachments as $key => $vendor_attachments) {
                    
                         echo "<div class='col-md-4 order_by_image'>";
                          echo "<div class='thumbnail'>";
                           $url  = "'".SITE_URL.CREDIT_REPORT.'vendor_file'.'/'.$vendor_attachments."'";
                           $myWin  = "'"."myWin"."'";
                           $attribute  = "'"."height=250,width=480"."'";
                            echo '<a href="javascript:;" ondblClick="myOpenWindow('.$url.','.$myWin.','.$attribute.'); return false"><img src="'.SITE_URL.CREDIT_REPORT.'vendor_file'.'/'.$vendor_attachments.'" class="img-rounded" alt="attachments missign" width="304" height="236"></a> ';
                          echo "</div>";
                         echo "</div>";
                    }
          ...
          <?php
           ...
           echo '<p style="text-align:justify;">All services and reports are provided in a professional manner in accordance with industry standards. Except as expressly provided, <b>'.CRMNAME.'</b> and its affiliates make no and disclaim any and all warranties and representations with respect to the services provided herein, whether such warranties and representations are express or implied in fact or by operation of law or otherwise, including without limitation implied warranties of merchantability and fitness for a particular purpose and implied warranties arising from the course of dealing or a course of performance with respect to the accuracy, validity, or completeness of any service or report.</p> <p style="text-align:justify;">Furthermore, '.CRMNAME.' and its affiliates
             expressly disclaim that the services will meet the clients requirements and '.CRMNAME.'s and its affiliates express disclaim all such representations and warranties. '.CRMNAME.' merely passes on to client information in the form of reports which '.CRMNAME.' has obtained in respect of the subject of a background screening verification. '.CRMNAME.' is not the author  or creator of that information. Given the limitations, no responsibility will be taken by '.CRMNAME.' for the consequences of client in reliance upon information contained in this information or report. However, '.CRMNAME.' will provide reasonable procedures to protect against any false information being provided to the client. The information within the reports is strictly confidential and is intended to be for the sole purpose of the clients 
        ...
        <html>
          ...
          <div style="float: left;margin: 15px">
            ...
            <table width="97%" cellpadding="5" cellspacing="pixels">
              ...
              <tr>
                <td colspan="4" style="background-color: #0000000f;" style="text-align: center;height: 35px;"><b> <?=  strtoupper($candidate_details['clientname']) ?> </b></td>
              </tr>
            </table>
            ...
            <table width="97%" cellpadding="5" cellspacing="pixels">
              ...
              <tr>
                <td colspan="4" style="background-color: #0000000f;" style="text-align: center;height: 35px;"><b> BACKGROUND VERIFICATION INTERIM REPORT </b></td>
              </tr>
            </table>
