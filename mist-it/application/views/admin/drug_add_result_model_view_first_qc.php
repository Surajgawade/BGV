<div class="modal-body">
  ...
  <div class="row">
    ...
    <div class="col-md-4 col-sm-12 col-xs-4 form-group">
      ...
      <input type="text" name="drug_com_ref" id="drug_com_ref" readonly="readonly" value="<?php echo set_value('drug_com_ref',$details['drug_com_ref']); ?>" class="form-control">
    ...
    <div class="col-md-4 col-sm-12 col-xs-34 form-group">
      ...
      <?php
        echo form_dropdown('amphetamine_screen', array('negetive' => 'Negetive','positive' => 'Positive'), set_value('amphetamine_screen',$details['amphetamine_screen']), 'class="form-control" id="amphetamine_screen"');
    ...
    <div class="col-md-4 col-sm-12 col-xs-34 form-group">
      ...
      <?php
        echo form_dropdown('cannabinoids_screen', array('negetive' => 'Negetive','positive' => 'Positive'), set_value('cannabinoids_screen',$details['cannabinoids_screen']), 'class="form-control" id="cannabinoids_screen"');
    ...
    <div class="col-md-4 col-sm-12 col-xs-34 form-group">
      ...
      <?php
        echo form_dropdown('cocaine_screen', array('negetive' => 'Negetive','positive' => 'Positive'), set_value('cocaine_screen',$details['cocaine_screen']), 'class="form-control" id="cocaine_screen"');
    ...
    <div class="col-md-4 col-sm-12 col-xs-34 form-group">
      ...
      <?php
        echo form_dropdown('opiates_screen', array('negetive' => 'Negetive','positive' => 'Positive'), set_value('opiates_screen',$details['opiates_screen']), 'class="form-control" id="opiates_screen"');
    ...
    <div class="col-md-4 col-sm-12 col-xs-34 form-group">
      ...
      <?php
        echo form_dropdown('phencyclidine_screen', array('negetive' => 'Negetive','positive' => 'Positive'), set_value('phencyclidine_screen',$details['phencyclidine_screen']), 'class="form-control" id="phencyclidine_screen"');
