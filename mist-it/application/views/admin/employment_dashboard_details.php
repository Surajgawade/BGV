                    ...
                    <thead><tr>
                      ...
                      foreach ($lists as $key => $value) {
                        echo "<tr>";
                          ...
                          echo "<td>".$value['coname']."</td>";
                          echo "<td>".$value['vendor_name']."</td>";
                          echo "<td>".$value['verfstatus']."</td>";
                          echo "<td>".$value['field_visit_status']."</td>";
