  ...
  <div class="row">
        <div class="col-sm-12">
          <div class="page-title-box">
            <h5 class="page-title">Edit Role</h5>
              <ol class="breadcrumb">
      ...
      <div class="card m-b-20">
       <div class="card-body">
            <div style="float: right;">
              ...
              <button class="btn btn-secondary waves-effect  btn-sm edit_btn_click" data-frm_name='save_new_groups' data-editUrl="<?= ($this->permission['access_admin_role_edit']) ? encrypt($role_details['id']) : ''?>"><i class="fa fa-edit"></i> Edit</button>
              <button class="btn btn-secondary waves-effect btn-sm btn_clicked" data-accessUrl="<?= ($this->permission['access_admin_role_delete']) ? ADMIN_SITE_URL.'roles/delete/'.encrypt($role_details['id']) : '' ?>"><i class="fa fa-trash"></i> Delete</button>
           </div>
            ...
            <?php echo form_open('#', array('name'=>'save_new_groups','id'=>'save_new_groups')); ?>
             <div class="row">
              <div class="col-xs-4 col-md-4 col-sm-12">
                ...
                <input type="hidden" name="hidden_uid" value="<?= $role_details['id'];?>">
                <input type="hidden" name="hidden_grp_sel" id="hidden_grp_sel" value="<?= $role_details['groups_id'];?>">
                <input type="text" name="role_name" id="role_name" value="<?php echo set_value('role_name',$role_details['role_name']); ?>" class="form-control">
              ...
              <div class="col-xs-4 col-md-4 col-sm-12">
                ...
                <textarea name="role_description" rows="1" id="role_description" class="form-control"><?= $role_details['role_description']?></textarea>
              </div>
            </div>
             ...
             <!--   <fieldset id="fieldset_user_global_rights">
                  <legend data-submenu-label="Global">Global privileges
                    <input type="checkbox" id="global_checkall" data-check='cfalse' class="checkall_box" title="Check all"> <label for="global_checkall" id='change_text'>Check all</label> 
                  </legend>
                  <?php
                  foreach ($access as $key => $value) {
                      if (strpos($value, 'access_') !== false) {
                        if($role_details[$value] == 1)
                          $checked = 'checked';
                        else
                          $checked = '';
                  ?>
                  <div class="item">
                      <input type="checkbox" class="single_check_box" <?= $checked?> name="permission[]" id="<?php echo $value; ?>" value="<?php echo $value; ?>" title="Click to allow page access of <?php echo $value; ?>">
              ...
              <div class="col-xs-12 col-md-12 col-sm-12" id = "admin" style="display: none">
                <fieldset id="fieldset_user_global_rights">
                              ...
                              { 
                                ...
                                ?> 
                                  <div class="item col-md-4 col-sm-12 col-xs-4" >
                                      <input type="checkbox" class="single_check_box_admin" <?= $checked?>  name="permission[]" id="<?php echo $value; ?>" value="<?php echo $value; ?>" title="Click to allow page access of <?php echo $value; ?>">
                                      <label for="<?php echo $value; ?>"><?php echo ucwords(str_replace('access', ' ', str_replace('_', ' ', $value)));?></label>
                                  </div>
                              <?php
                        ...
                        { 
                            ...
                            if (strpos($value, 'access_clients_list') !== false)  
                              ...
                              { 
                                ...
                                ?> 
                                  <div class="item col-md-4 col-sm-12 col-xs-4" >
                                      <input type="checkbox" class="single_check_box_client" <?= $checked?>  name="permission[]" id="<?php echo $value; ?>" value="<?php echo $value; ?>" title="Click to allow page access of <?php echo $value; ?>">
                                      <label for="<?php echo $value; ?>"><?php echo ucwords(str_replace('access', ' ', str_replace('_', ' ', $value)));?></label>
                                  </div>
                              <?php
                        ...
                        { 
                            ...
                            if (strpos($value, 'access_candidates_list') !== false)  
                              ...
                              { 
                                ...
                                ?> 
                                  <div class="item col-md-4 col-sm-12 col-xs-4" >
                                      <input type="checkbox" class="single_check_box_candidates" <?= $checked?>  name="permission[]" id="<?php echo $value; ?>" value="<?php echo $value; ?>" title="Click to allow page access of <?php echo $value; ?>">
                                      <label for="<?php echo $value; ?>"><?php echo ucwords(str_replace('access', ' ', str_replace('_', ' ', $value)));?></label>
                                  </div>
                              <?php
              ...
              <div class="col-xs-12 col-md-12 col-sm-12" id = "address" style="display: none" > 
                        ...
                        { 
                            ...
                            if (strpos($value, 'access_address_list') !== false)  
                              ...
                              { 
                                ...
                                ?> 
                                  <div class="item col-md-4 col-sm-12 col-xs-4" >
                                      <input type="checkbox" class="single_check_box_address" <?= $checked?> name="permission[]" id="<?php echo $value; ?>" value="<?php echo $value; ?>" title="Click to allow page access of <?php echo $value; ?>">
                                      <label for="<?php echo $value; ?>"><?php echo ucwords(str_replace('access', ' ', str_replace('_', ' ', $value)));?></label>
                                  </div>
                              <?php
                        ...
                        { 
                            ...
                            if (strpos($value, 'access_employment_list') !== false)  
                              ...
                              { 
                                ...
                                ?> 
                                  <div class="item col-md-4 col-sm-12 col-xs-4" >
                                      <input type="checkbox" class="single_check_box_employment" <?= $checked?> name="permission[]" id="<?php echo $value; ?>" value="<?php echo $value; ?>" title="Click to allow page access of <?php echo $value; ?>">
                                      <label for="<?php echo $value; ?>"><?php echo ucwords(str_replace('access', ' ', str_replace('_', ' ', $value)));?></label>
                                  </div>
                              <?php
                                  }
                        ...
                        { 
                            ...
                            if (strpos($value, 'access_education_list') !== false)  
                              ...
                              { 
                                ...
                                ?> 
                                  <div class="item col-md-4 col-sm-12 col-xs-4" >
                                      <input type="checkbox" class="single_check_box_education" <?= $checked?> name="permission[]" id="<?php echo $value; ?>" value="<?php echo $value; ?>" title="Click to allow page access of <?php echo $value; ?>">
                                      <label for="<?php echo $value; ?>"><?php echo ucwords(str_replace('access', ' ', str_replace('_', ' ', $value)));?></label>
                                  </div>
                              <?php
                                   }
                        ...
                        { 
                            ...
                            if (strpos($value, 'access_reference_list') !== false)  
                              ...
                              { 
                                ...
                                ?> 
                                  <div class="item col-md-4 col-sm-12 col-xs-4" >
                                      <input type="checkbox" class="single_check_box_reference" <?= $checked?> name="permission[]" id="<?php echo $value; ?>" value="<?php echo $value; ?>" title="Click to allow page access of <?php echo $value; ?>">
                                      <label for="<?php echo $value; ?>"><?php echo ucwords(str_replace('access', ' ', str_replace('_', ' ', $value)));?></label>
                                  </div>
                              <?php
                                }
                        ...
                        { 
                            ...
                            if (strpos($value, 'access_court_list') !== false)  
                              ...
                              { 
                                ...
                                ?> 
                                  <div class="item col-md-4 col-sm-12 col-xs-4" >
                                      <input type="checkbox" class="single_check_box_court"  <?= $checked?> name="permission[]" id="<?php echo $value; ?>" value="<?php echo $value; ?>" title="Click to allow page access of <?php echo $value; ?>">
                                      <label for="<?php echo $value; ?>"><?php echo ucwords(str_replace('access', ' ', str_replace('_', ' ', $value)));?></label>
                                  </div>
                              <?php
                                 }
                ...
                <div class="col-xs-12 col-md-12 col-sm-12" id = "global" style="display: none" > 
                 ...
                 <fieldset id="fieldset_user_global_rights">
                  <legend data-submenu-label="Global">GLOBAL DATABSE 
                        ...
                        { 
                            ...
                            if (strpos($value, 'access_global_list') !== false)  
                              ...
                              { 
                                ...
                                ?> 
                                  <div class="item col-md-4 col-sm-12 col-xs-4" >
                                      <input type="checkbox" class="single_check_box_global" <?= $checked?> name="permission[]" id="<?php echo $value; ?>" value="<?php echo $value; ?>" title="Click to allow page access of <?php echo $value; ?>">
                                      <label for="<?php echo $value; ?>"><?php echo ucwords(str_replace('access', ' ', str_replace('_', ' ', $value)));?></label>
                                  </div>
                              <?php
                                  }
                        ...
                        { 
                            ...
                            if (strpos($value, 'access_drugs_list') !== false)  
                              ...
                              { 
                                ...
                                ?> 
                                  <div class="item col-md-4 col-sm-12 col-xs-4" >
                                      <input type="checkbox" class="single_check_box_drugs" <?= $checked?> name="permission[]" id="<?php echo $value; ?>" value="<?php echo $value; ?>" title="Click to allow page access of <?php echo $value; ?>">
                                      <label for="<?php echo $value; ?>"><?php echo ucwords(str_replace('access', ' ', str_replace('_', ' ', $value)));?></label>
                                  </div>
                              <?php
                                 }
                        ...
                        { 
                            ...
                            if (strpos($value, 'access_pcc_list') !== false)  
                              ...
                              { 
                                ...
                                ?> 
                                  <div class="item col-md-4 col-sm-12 col-xs-4" >
                                      <input type="checkbox" class="single_check_box_pcc" <?= $checked?> name="permission[]" id="<?php echo $value; ?>" value="<?php echo $value; ?>" title="Click to allow page access of <?php echo $value; ?>">
                                      <label for="<?php echo $value; ?>"><?php echo ucwords(str_replace('access', ' ', str_replace('_', ' ', $value)));?></label>
                                  </div>
                              <?php
                                  }
                        ...
                        { 
                            ...
                            if (strpos($value, 'access_identity_list') !== false)  
                              ...
                              { 
                                ...
                                ?> 
                                  <div class="item col-md-4 col-sm-12 col-xs-4" >
                                      <input type="checkbox" class="single_check_box_identity" <?= $checked?> name="permission[]" id="<?php echo $value; ?>" value="<?php echo $value; ?>" title="Click to allow page access of <?php echo $value; ?>">
                                      <label for="<?php echo $value; ?>"><?php echo ucwords(str_replace('access', ' ', str_replace('_', ' ', $value)));?></label>
                                  </div>
                              <?php
                                  }
                        ...
                        { 
                            ...
                            if (strpos($value, 'access_credit_list') !== false)  
                              ...
                              { 
                                ...
                                ?> 
                                  <div class="item col-md-4 col-sm-12 col-xs-4" >
                                      <input type="checkbox" class="single_check_box_credit" <?= $checked?> name="permission[]" id="<?php echo $value; ?>" value="<?php echo $value; ?>" title="Click to allow page access of <?php echo $value; ?>">
                                      <label for="<?php echo $value; ?>"><?php echo ucwords(str_replace('access', ' ', str_replace('_', ' ', $value)));?></label>
                                  </div>
                              <?php
                                  }
                        ...
                        { 
                            ...
                            if (strpos($value, 'access_task_list') !== false)  
                              ...
                              { 
                                ...
                                ?> 
                                  <div class="item col-md-4 col-sm-12 col-xs-4" >
                                      <input type="checkbox" class="single_check_box_task_manager" <?= $checked?> name="permission[]" id="<?php echo $value; ?>" value="<?php echo $value; ?>" title="Click to allow page access of <?php echo $value; ?>">
                                      <label for="<?php echo $value; ?>"><?php echo ucwords(str_replace('access', ' ', str_replace('_', ' ', $value)));?></label>
                                  </div>
                              <?php
                    ...
                    { 
                        ...
                        if (strpos($value, 'access_final_list') !== false)  
                          ...
                          { 
                            ...
                            ?> 
                              <div class="item col-md-4 col-sm-12 col-xs-4" >
                                  <input type="checkbox" class="single_check_box_final_qc" <?= $checked?> name="permission[]" id="<?php echo $value; ?>" value="<?php echo $value; ?>" title="Click to allow page access of <?php echo $value; ?>">
                                  <label for="<?php echo $value; ?>"><?php echo ucwords(str_replace('access', ' ', str_replace('_', ' ', $value)));?></label>
                              </div>
                          <?php
                      ...
                      { 
                          ...
                          if (strpos($value, 'access_report_list') !== false)  
                            ...
                            { 
                              ...
                              ?> 
                                <div class="item col-md-4 col-sm-12 col-xs-4" >
                                    <input type="checkbox" class="single_check_box_report" <?= $checked?> name="permission[]" id="<?php echo $value; ?>" value="<?php echo $value; ?>" title="Click to allow page access of <?php echo $value; ?>">
                                    <label for="<?php echo $value; ?>"><?php echo ucwords(str_replace('access', ' ', str_replace('_', ' ', $value)));?></label>
                                </div>
                            <?php
                        ...
                        { 
                            ...
                            if (strpos($value, 'access_social_media_list') !== false)  
                              ...
                              { 
                                  ...
                                  if(($value != 'access_social_media_list_assign') and ($value != 'access_identity_list_re_assign'))
                                  {
                                ?> 
                                  <div class="item col-md-4 col-sm-12 col-xs-4" >
                                      <input type="checkbox" class="single_check_box_social_media" <?= $checked?> name="permission[]" id="<?php echo $value; ?>" value="<?php echo $value; ?>" title="Click to allow page access of <?php echo $value; ?>">
                                      <label for="<?php echo $value; ?>"><?php echo ucwords(str_replace('access', ' ', str_replace('_', ' ', $value)));?></label>
                                  </div>
                              <?php
                                  }
...
$(document).ready(function(){
  ...
  $("#save_new_groups :input").prop("disabled", true);
  ...
  var hidden_grp_sel = $('#hidden_grp_sel').val();
  hidden_grp_sel =  hidden_grp_sel.split(',').map(Number)
  
  $('#groups_id').multiselect('select',hidden_grp_sel);
  ...
  $('#save_new_groups').validate({ 
      ...
      {
          $.ajax({
            url : '<?php echo ADMIN_SITE_URL.'roles/update_role'; ?>',
            data : $( form ).serialize(),
            type: 'post',
            dataType:'json',
            beforeSend:function(){
            ...
            success: function(jdata){
              ...
              if(jdata.status == '<?php echo SUCCESS_CODE; ?>'){
                show_alert(message,'success');
                   setTimeout(function () {
             window.location.href= '<?php echo ADMIN_SITE_URL.'roles'; ?>';
            }, 1000);
              }
...
$(document).ready(function(){
   ...
   var id = '<?php echo $role_details['groups_id'] ?>';

  $.ajax({
        url: '<?php echo ADMIN_SITE_URL.'roles/get_page_name_details'; ?>',
        type: 'post',
        data: {id:id},
      ...
      success: function(jdata){
              ...
              if($.inArray("pcc",message) !== -1)
               ...
               if($.inArray("task manager",message) !== -1)
               {
                 $('#task').show();
                }
