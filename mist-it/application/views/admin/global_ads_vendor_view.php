...
<div class="col-md-3 col-sm-8 col-xs-3 form-group">
  ...
  <input type="text" name="entity_name" id="entity_name" value="<?php echo set_value('entity_name',$details['entity_name']); ?>"s class="form-control cls_readonly">
</div>
...
<div class="col-md-3 col-sm-12 col-xs-3 form-group">
        ...
        <?php
         echo form_dropdown('address_type', ADDRESS_TYPE, set_value('address_type',$details['address_type']), 'class="form-control cls_readonly" id="address_type"');
