      ...
      <div class="row">
        <div class="col-sm-12 col-md-12">
          <div class="box box-primary">
            <?php echo form_open('#', array('name'=>'frm_reference_export_report','id'=>'frm_reference_export_report')); ?>
              <div class="box-body">
...
$(document).ready(function(){
  ...
  $('#frm_reference_export_report').validate({ 
    rules: {
    },
    messages: {
    },
    ...
    {      
        $.ajax({
            url : '<?php echo ADMIN_SITE_URL.'reports/reference_export'; ?>',
