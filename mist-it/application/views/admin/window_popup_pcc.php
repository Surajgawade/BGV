              ...
              <div class="box-header">
                <div class="box-body">
                  <table id="tbl_datatable" class="table table-bordered table-hover">
                    <thead><tr>
                     <th>Sr No.</th><th>Client Name</th><th>Entity</th><th>Package</th><th>Client Ref No</th><th><?php echo REFNO; ?></th><th>Candidate Name</th><th>Received Date</th><th>Component Ref No</th><th>Component Initiation Date</th><th>Address type</th><th>Street Address</th><th>City</th><th>Pincode</th><th>State</th><th>Reference</th><th>Contact Number</th><th>Reference 1</th><th>Contact Number 2</th><th>Vendor</th><th>Executive Name</th><th>Mode of verification</th><th>Application ID/Ref</th><th>Submission Date</th><th>Police Station</th><th>Police station visit date</th><th>Name/Designation of the police personnel</th><th>Contact number of the police personnel</th><th>Attachment</th><th>Verification Status</th><th>Remarks</th><th>QC Status</th><th>TAT Status</th><th>Check Closure Date</th><th>Last Activity</th>
                      </tr>
                    </thead>
                      <?php
                      $x = 1;
                      foreach ($lists as $key => $list) {
                        echo "<tr>";
                          ...
                          echo "<td>".$list['pcc_com_ref']."</td>";
                          echo "<td>".$list['iniated_date']."</td>";
                          echo "<td>".$list['address_type']."</td>";
                          ...
                          echo "<td>".$list['application_id_ref']."</td>";
                          echo "<td>".$list['submission_date']."</td>";
                          echo "<td>".$list['police_station']."</td>";
                          echo "<td>".$list['police_station_visit_date']."</td>";
                          echo "<td>".$list['name_designation_police']."</td>";
                          echo "<td>".$list['contact_number_police']."</td>";
