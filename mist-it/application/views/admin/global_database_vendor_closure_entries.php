                    ...
                    <table id="tbl_activity_log" class="table table-bordered  nowrap"  style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                      ...
                      <?php
                        ...
                        foreach ($vendor_executive_list as $key => $value) {
                            $html_view .= "<tr id = ".$value['global_database_id']." url = ".ADMIN_SITE_URL."global_database/View_vendor_log1/".$value['id']." >";
                            $html_view .= "<td>".$i."</td>";
...
/* $('#filter_executive').on('change', function(){
    ...
    $.ajax({
            type:'GET',
            url:'<?php echo ADMIN_SITE_URL.'global_database/global_database_closure_entries/' ?>'+filter_executive,
            data : '',
            dataType:'html',
