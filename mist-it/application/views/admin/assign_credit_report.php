			<div class="row">
				 <div class="col-sm-12">
						<div class="page-title-box">
								<h4 class="page-title">Credit Report - Assign Credit Report</h4>
									<ol class="breadcrumb">
										 <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>dashboard"><?php echo SHORT_CO_NAME ?></a></li>
										 <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>credit_report">Credit Report</a></li>
										 <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>assign_credit_report">Assign Credit Report</a></li>
										 <li class="breadcrumb-item active">List View</li>
									</ol>
						
									<div class="state-information d-none d-sm-block">
										<ol class="breadcrumb">
											<?php $access_export = ($this->permission['access_credit_list_export']) ? '#myModalExport'  : ''; ?>
					...
					<div class="card m-b-20">
						<div class="card-body">
							<div class="row">
							 ...
							 <table id="tbl_datatable_assign_credit"  class="table table-bordered  nowrap"  style="border-collapse: collapse; border-spacing: 0; width: 100%;">
									<thead>
										<tr>
...
$(document).ready(function() {
	...
	var oTable =  $('#tbl_datatable_assign_credit').DataTable( {
				"serverSide": true,
				"processing": true,
				 bSortable: true,
				 bRetrieve: true,
				...
				"ajax": $.fn.dataTable.pipeline( {
						url: "<?php echo ADMIN_SITE_URL.'assign_credit_report/credit_report_view_datatable_assign'; ?>",
						pages: 1,
						async: true,
						method: 'POST',
				...
				"columns":[{'data' :'checkbox'},{'data' :'id'},{'data' :'ClientRefNumber'},{'data' :'credit_report_com_ref'},{'data' :'iniated_date'},{"data":"clientname"},{"data":"CandidateName"},{"data":"verfstatus"},{'data' :'id_number'},{'data' :'executive_name'},{"data":"first_qc_approve"},{"data":"tat_status"},{"data":"due_date"},{'data':"last_activity_date"}]
	} );
	...
	$('#tbl_datatable_assign_credit tbody').on('dblclick', 'tr', function () { 
  ...
  $('#tbl_datatable_assign_credit tbody').on( 'click', 'tr', function () {
    ...
    $('#tbl_datatable_assign_credit').on('click', 'tbody td, thead th:first-child', function(e){
	...
	$('#filter_by_clientid,#filter_by_status').on('change', function(){
		...
		var new_url = "<?php echo ADMIN_SITE_URL.'court_verificatiion/court_view_datatable'; ?>?filter_by_clientid="+filter_by_clientid+"&filter_by_status="+filter_by_status;
	...
	$('#btn_assign_action_vendor').on('click', function(e){
	  ...
	  var select_one = oTable.column(0).checkboxes.selected().join(",");
		...
		if(vendor_list != "0" && select_one != "")
		{
				$.ajax({
					type:'POST',
					url:'<?php echo ADMIN_SITE_URL.'credit_report/assign_to_vendor/' ?>',
...
$('#download_candidate_template').click(function(e) {
		e.preventDefault();
		window.location.href = "<?= COM_ATTACHMENTS_PATH.COURT_VERIFICATION.'/court_bulk_template.xlsx'; ?>" ;
});
</script>
