                    ...
                    <table id="tbl_vendor_insuff" class="table table-bordered  nowrap"  style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                      ...
                      <?php
                        ...
                        foreach ($vendor_executive_list as $key => $value) {
                            ...
                            $html_view .= "<tr id = ".$value['employment_id']." url = ".ADMIN_SITE_URL."education/check_insuff_already_raised/".$value['employment_id']." >";
                            $html_view .= "<td>".$i."</td>";
                            ...
                            $html_view .= "<td>".$value['company_name']."</td>";
                            ...
                            $html_view .= "<td>".$value['emp_com_ref']."</td>";
...
$('#tbl_vendor_insuff').on('dblclick', 'tr', function () { 
  ...
  $('#filter_executive_insuff').on('change', function(){
    ...
    $.ajax({
            type:'GET',
            url:'<?php echo ADMIN_SITE_URL.'employment/employment_closure_entries_vendor_insuff/' ?>'+filter_executive,
            data : '',
            dataType:'html',
