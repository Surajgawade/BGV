...
<br>
<?php echo form_open_multipart('#', array('name'=>'frm_social_media','id'=>'frm_social_media')); ?>
  <div class="box-body">
    <div class="row">
    ...
    ?>
      <div class="col-sm-4 form-group">
        <label>Mode of Verification</label>
         <input type="text" name="mode_of_veri" readonly="readonly" id="mode_of_veri" value="<?php if(isset($mode_of_verification_value->social_media)) { echo $mode_of_verification_value->social_media; } ?>" class="form-control">
    ...
    <div class="col-sm-4 form-group">
      <input type="submit" name="btn_social_media" id='btn_social_media' value="Submit" class="btn btn-success">
...
$(document).ready(function(){
  ...
  $('.readonly').prop('readonly', true);
    ...
    submitHandler: function(form) 
    {
      ...
      $.ajax({
        url : '<?php echo ADMIN_SITE_URL.'social_media/save_form'; ?>',
        ...
        dataType:'json',
        beforeSend:function(){
          $('#btn_social_media').attr('disabled','disabled');
