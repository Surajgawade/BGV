      ...
      <div class="row">
         <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Global DB - Global AQ</h4>
                  <ol class="breadcrumb">
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>dashboard"><?php echo SHORT_CO_NAME ?></a></li>
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>global_database">Global DB</a></li>
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>global_database/approval_queue">Global AQ</a></li>
...
<div id="addAddResultModel" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-lg" >
    ...
    <div class="modal-content">
      ...
      <input type="hidden" id="glodbver_id" name="glodbver_id" value="<?php echo set_value('glodbver_id'); ?>">
      <input type="hidden" id="clientid"  name="clientid" value="<?php echo set_value('clientid'); ?>">
      <input type="hidden" id="global_result_id" name="glodbver_result_id" value="<?php echo set_value('glodbver_result_id'); ?>">
...
<div id="showvendorModel" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-lg" >
    ...
    <div class="modal-content">
      ...
      <input type="hidden" name="global_id" id = "global_id"  class = "global_id" value="">
     ...
     <div class="showbutton1" style="display: none;">
      ...
      ="<?= ADMIN_SITE_URL.'activity_log/activity_log_view_vendor_form/7/' ?>" data-toggle="modal" id="activityModelClk1" type="button" >Approve</button>
...
$(document).ready(function() {
  ...
  var oTable =  $('#example').DataTable( {
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: "<?php echo ADMIN_SITE_URL.'global_database/view_approval_queue'; ?>",
        ...
        "columns":[{'data' :'checkbox'},{'data' :'id'},{"data":"global_com_ref"},{"data":"clientname"},{"data":"entity_name"},{"data":"package_name"},{'data' :'vendor_name'},{'data' :'city'},{'data' :'pincode'},{'data' :'state'},{'data' :'allocated_by'},{"data":"allocated_on"}]
  });
...
$(document).on('click', '#btn_assign', function(){
    ...
    { 
       ...
       else
       {
        $.ajax({
          type:'POST',
          url:'<?php echo ADMIN_SITE_URL.'global_database/global_final_assigning/' ?>',
    ...
    { 
      ...
      if(cases_assgin_action == 2 && reject_reason == "")
       ...
       else
       {
        ...
        $.ajax({
          type:'POST',
          url:'<?php echo ADMIN_SITE_URL.'global_database/global_database_closure/' ?>',
...
$(document).on('click','#activityModelClk1',function() {
 ...
 var global_result_id  = $('#global_result_id1').val();


 document.getElementById("glodbver_id").value = component_id; 
 ...
 document.getElementById("global_result_id").value = global_result_id; 
...
<script type="text/javascript">
  ...
  $('#view_result_log_tabs').click(function(){
    ...
    $.ajax({
      type : 'POST',
      url : '<?php echo ADMIN_SITE_URL.'global_database/global_database_closure_entries/' ?>',
      data: '',
      beforeSend :function(){
