...
<input type="hidden" name="credit_report_id" id="credit_id" value="<?php echo set_value('credit_id',$details['id']); ?>">
...
<input type="hidden" name="component_ref_no" id="component_ref_no" value="<?php echo set_value('component_ref_no',$details['credit_report_com_ref']); ?>">
...
<input type="hidden" name="credit_report_result_id" id="credit_report_result_id1" value="<?php echo set_value('credit_report_result_id',$details['credit_report_result_id']); ?>">
...
<div class="col-md-3 col-sm-12 col-xs-3 form-group">
  ...
  <input type="text" name="credit_report_com_ref" id="credit_report_com_ref"  value="<?php echo set_value('credit_report_com_ref',$details['credit_report_com_ref']); ?>" class="form-control cls_readonly">
</div>
</div>
<div class="row">
