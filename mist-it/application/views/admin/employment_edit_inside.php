    ...
    <div class="modal-content">
      ...
      <div class="form-row mb-3">
        <label for="to" class="col-2 col-sm-1 col-form-label">Subject:</label>
          <div class="col-10 col-sm-11">
            <input type="text" class="form-control" id="subject" name="subject" placeholder="Type email" value="<?php  echo "Employment verification of ".ucwords($email_info['CandidateName'])." - ".$email_info['emp_com_ref']?>" readonly>
          </div>
      </div>
        ...
        <div class="row">
          ...
          <br>
            ...
            <div class="form-row mb-3">
                <label for="to" class="col-2 col-sm-1 col-form-label">Subject:</label>
                <div class="col-10 col-sm-11">
                    <input type="text" class="form-control" id="subject" name="subject" placeholder="Type email" value="<?php  echo "Employment verification summary of ".ucwords($email_info['CandidateName'])." - ".$email_info['emp_com_ref']?>" readonly>
                </div>
            </div>
