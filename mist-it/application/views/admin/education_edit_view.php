          ...
          <div class="page-title-box">
            <h4 class="page-title">Edit Education</h4>
              ...
              <div style="float: right;">
                <ol class="breadcrumb">
                    <li><button class="btn btn-secondary waves-effect btn_clicked btn-sm" data-accessUrl="<?= ADMIN_SITE_URL?>education"><i class="fa fa-arrow-left"></i> Back</button></li>  
               </ol>
              </div>
          </div>
        </div>
      ...
      <div class="card m-b-20">
        ...
        <div class="nav-tabs-custom">
          <ul class="nav nav-pills nav-justified" role="tablist">
            <li class="nav-item waves-effect waves-light active"><a class = 'nav-link active' href="#address_tab" data-toggle="tab">Education Details</a></li>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button  type="button" class="btn btn-info btn-sm" id="university_image" data-url="<?= ADMIN_SITE_URL.'education/university_image_selection/'.$selected_data['university_board'] ?>">University Image</button>
...
<div id="showAddResultModel" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <input type="hidden" name="university_images_result"  id="university_images_result" value="">


       <input type="hidden" name="url_action" value="" id="url_action">
      <div id="append_result_model1"></div>
      <div class="modal-footer">
        <button  type="button" class="btn btn-info btn-sm" id="university_image_result_log" data-url="<?= ADMIN_SITE_URL.'education/university_image_selection/'.$selected_data['university_board'] ?>">University Image</button>
...
<div id="UniversityModelResult" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-lg">
  <?php echo form_open('#', array('name'=>'frm_submit_university_images_result','id'=>'frm_submit_university_images_result')); ?>
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">University Images</h4>
     ...
     <div class="modal-body">
        <div class="append-university_display_result"></div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-success" id="submit_university_images_result" name="submit_university_images_result">Submit</button>
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
    </div>
    <?php echo form_close(); ?>
...
$(document).ready(function(){
 ...
 $('#university_image').click(function(){
      ...
      $('.append-university_display').load(url,function(){
  ...
  $('#university_image_result_log').click(function(){
  
      var url = $(this).data("url");
     
      $('.append-university_display_result').load(url,function(){
        $('#UniversityModelResult').modal('show');
        $('#UniversityModelResult').addClass("show");
        $('#UniversityModelResult').css({background: "#0000004d"});
      });
  ...
  $('#submit_university_images_result').click(function(){
      var fields = $("#frm_submit_university_images_result").serializeArray();
               
      var myarray = [];    
      jQuery.each(fields, function(i, field){
          myarray.push(field.value);
      });
      $("#university_images_result").val(myarray);
      $('#UniversityModelResult').modal('hide');
  });
