<div class="content-page">
  <div class="content">
    ...
    <div class="row">
         <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Identity - Identity AQ</h4>
                  <ol class="breadcrumb">
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>dashboard"><?php echo SHORT_CO_NAME ?></a></li>
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>identity">Identity</a></li>
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>identity/approval_queue">Identity AQ</a></li>
   ...
   // echo "<li  role='presentation' data-url='".ADMIN_SITE_URL."identity/vendor_cost_approval/' data-can_id='1' data-tab_name='vendor_cost_approve'  class='nav-item waves-effect waves-light view_component_tab'><a class = 'nav-link' href='#vendor_cost_approve' aria-controls='home' role='tab' data-toggle='tab'>Vendor Charges</a></li>";


    echo "<li  role='presentation' data-url='".ADMIN_SITE_URL."identity/identity_closure_entries/'  data-tab_name='result_log_tabs' data-can_id='".$this->user_info['id']."'  class='nav-item waves-effect waves-light view_component_tab'><a class = 'nav-link' href='#result_log_tabs' aria-controls='home' role='tab'  data-toggle='tab'>Closure</a></li>";

    echo "<li  role='presentation' data-url='".ADMIN_SITE_URL."identity/identity_closure_entries_vendor_insuff/' data-can_id='".$this->user_info['id']."' data-tab_name='vendor_insuff_tab'  class='nav-item waves-effect waves-light view_component_tab'><a class = 'nav-link' href='#vendor_insuff_tab' aria-controls='home' role='tab' data-toggle='tab'>Vendor Insuff</a></li>";
   ?>
  </ul>
  ...
  <div class="tab-content">
    <div id="Vendor_assign_reject" class="tab-pane active">
     ...
     <div id="vendor_cost_approve" class="tab-pane fade in"></div>
...
$(document).ready(function() {
  ...
  var oTable =  $('#example').DataTable( {
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: "<?php echo ADMIN_SITE_URL.'identity/view_approval_queue'; ?>",
        ...
        "columns":[{'data' :'checkbox'},{'data' :'id'},{"data":"identity_com_ref"},{"data":"clientname"},{"data":"entity_name"},{"data":"package_name"},{'data' :'vendor_name'},{'data' :'city'},{'data' :'pincode'},{'data' :'state'},{'data' :'allocated_by'},{"data":"allocated_on"}]
  });
...
$(document).on('click', '#btn_assign', function(){
    ...
    { 
        $.ajax({
          type:'POST',
          url:'<?php echo ADMIN_SITE_URL.'identity/identity_final_assigning/' ?>',
    ...
    { 
      ...
      if(cases_assgin_action == 2 && reject_reason == "")
       ...
       else
       {
        ...
        $.ajax({
          type:'POST',
          url:'<?php echo ADMIN_SITE_URL.'identity/identity_closure/' ?>',
...
<script type="text/javascript">
  ...
  $('#view_result_log_tabs').click(function(){
    ...
    $.ajax({
      type : 'POST',
      url : '<?php echo ADMIN_SITE_URL.'identity/identity_closure_entries/' ?>',
      data: '',
      beforeSend :function(){
      ...
      var tbl_activity_log =  $('#tbl_activity_log').DataTable( {scrollX: true,scrollCollapse: true, "paging": true,  "processing": true,  "searching": false, "ordering": true,searching: false,bFilter: false,bLengthChange : true,bSortable: true,bRetrieve: true,"iDisplayLength": 5,"lengthChange": true,"lengthMenu": [[5,25, 50, -1], [5,25, 50, "All"]],"aaSorting": [] });
      }
    }); 
  })
</script>
