...
<br>
<?php echo form_open_multipart('#', array('name'=>'from_global','id'=>'from_global')); ?>
  <div class="box-body">
    <div class="row">
    ...
    ?>
      <div class="col-sm-4 form-group">
        <label>Mode of Verification</label>
         <input type="text" name="mode_of_veri" readonly="readonly" id="mode_of_veri" value="<?php if(isset($mode_of_verification_value->globdbver)) { echo $mode_of_verification_value->globdbver; } ?>" class="form-control">
    ...
    <div class="row">
    <div class="col-sm-4 form-group">
    <input type="checkbox" name="candidate_extract_global" id="candidate_extract_global" class="check_global" value="{TT_sticky_header}" onchange="stickyheaddsadaer_global(this)"/>
    <em> Check this box to get details from candidate</em>
  </div>
  <div class="col-sm-4 form-group">
    <input type="checkbox" name="address_extract_global" id="address_extract_global"  class="check_global" value="{TT_sticky_header}" onchange="stickyheaddsadaer_address_global(this)"/>
    ...
    <div class="col-sm-4 form-group">
      <input type="submit" name="btn_global" id='btn_global' value="Submit" class="btn btn-success">
...
<script type="text/javascript">
  ...
  $('.gen').prop('disabled', true);
    ...
    $('.check_global').click(function(){
      $('.check_global').not(this).prop('checked',false);
    });
  });
  

function stickyheaddsadaer_global(obj) {
  if($(obj).is(":checked")){
...
function stickyheaddsadaer_address_global(obj) {
  if($(obj).is(":checked")){
...
$(document).ready(function(){
  ...
  $('#from_global').validate({ 
    ...
    submitHandler: function(form) 
    {
      ...
      $.ajax({
        url : '<?php echo ADMIN_SITE_URL.'global_database/save_from'; ?>',
        ...
        dataType:'json',
        beforeSend:function(){
          $('#btn_global').attr('disabled','disabled');
