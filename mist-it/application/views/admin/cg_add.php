            ...
            <?php echo form_open('#', array('name'=>'frm_cg_add','id'=>'frm_cg_add')); ?>
              <div class="box-body">
                ...
                <div class="col-md-4 col-sm-12 col-xs-4 form-group">
                  ...
                  <input type="text" name="CGRefNumber" id="CGRefNumber" readonly="readonly" value="<?php echo set_value('CGRefNumber',$CGRefNumber); ?>" class="form-control">
...
$(document).ready(function(){
  ...
  $('#frm_cg_add').validate({ 
    ...
    {      
        $.ajax({
            url : '<?php echo ADMIN_SITE_URL.'cg/save_form'; ?>',
