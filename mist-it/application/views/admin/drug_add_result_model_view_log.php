...
<div class="modal-body">
  ...
  <div class="row" <?php echo $css_style; ?>>
    <div class="col-sm-4 form-group">
      ...
      <input type="text" name="mode_of_verification" id="mode_of_verification" readonly="readonly" value="<?php echo set_value('mode_of_verification',$details['mode_of_verification']);?>" class="form-control">
