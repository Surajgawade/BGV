<div class="content-page">
  <div class="content">
       ...
       <div class="row">
         <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Credit Report - Credit Report AQ</h4>
                  <ol class="breadcrumb">
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>dashboard"><?php echo SHORT_CO_NAME ?></a></li>
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>credit_report">Credit Report</a></li>
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>credit_report/approval_queue">Credit Report AQ</a></li>
   ...
   <?php  
    echo "<li class='nav-item waves-effect waves-light active'  role='presentation'><a class = 'nav-link active'  href='#Vendor_assign_reject' aria-controls='home' data-toggle='tab'>Vendor Assign/ Reject</a></li>";
     ...
     echo "<li  role='presentation' data-url='".ADMIN_SITE_URL."credit_report/credit_report_closure_entries/' data-can_id='".$this->user_info['id']."'  data-tab_name='result_log_tabs'  class='nav-item waves-effect waves-light view_component_tab'><a class = 'nav-link' href='#result_log_tabs' aria-controls='home' role='tab'  data-toggle='tab'>Closure</a></li>";

     echo "<li  role='presentation' data-url='".ADMIN_SITE_URL."credit_report/credit_report_closure_entries_vendor_insuff/' data-can_id='".$this->user_info['id']."' data-tab_name='vendor_insuff_tab'  class='nav-item waves-effect waves-light view_component_tab'><a class = 'nav-link' href='#vendor_insuff_tab' aria-controls='home' role='tab'  data-toggle='tab'>Vendor Insuff</a></li>";
  ...
  <div class="tab-content">
    ...
    <div id="result_log_tabs" class="tab-pane fade in"></div>
    <div id="vendor_insuff_tab" class="tab-pane fade in"></div>
...
<div id="addAddResultModel" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static" style="overflow-y: scroll;">
  <div class="modal-dialog modal-lg" >
    ...
    <div class="modal-content">
      ...
      <input type="hidden" id="cbrver_id" name="credit_report_id" value="<?php echo set_value('credit_report_id'); ?>">
      <input type="hidden" id="clientid"  name="clientid" value="<?php echo set_value('clientid'); ?>">
      
      <input type="hidden" id="credit_report_result_id" name="credit_report_result_id" value="<?php echo set_value('court_result_id'); ?>">
...
<div id="showvendorModel" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <input type="hidden" name="credit_report_id" id = "credit_report_id"  class = "credit_report_id" value="">
...
$(document).ready(function() {
  ...
  var oTable =  $('#tbl_datatable').DataTable( {
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: "<?php echo ADMIN_SITE_URL.'credit_report/view_approval_queue'; ?>",
        ...
        "columns":[{'data' :'checkbox'},{'data' :'id'},{"data":"credit_report_com_ref"},{"data":"clientname"},{"data":"entity_name"},{"data":"package_name"},{'data' :'vendor_name'},{'data' :'city'},{'data' :'pincode'},{'data' :'state'},{'data' :'allocated_by'},{"data":"allocated_on"}]
  });
    ...
    { 
      ...
      if(cases_assgin_action == 2 && reject_reason == "")
       ...
       else
       {
        $.ajax({
          type:'POST',
          url:'<?php echo ADMIN_SITE_URL.'credit_report/credit_report_final_assigning/' ?>',
    ...
    { 
      ...
      if(cases_assgin_action == 2 && reject_reason == "")
       ...
       else
       {
        ...
        $.ajax({
          type:'POST',
          url:'<?php echo ADMIN_SITE_URL.'credit_report/credit_report_closure/' ?>',
...
<script type="text/javascript">
  ...
  $('#view_result_log_tabs').click(function(){
    ...
    $.ajax({
      type : 'POST',
      url : '<?php echo ADMIN_SITE_URL.'credit_report/credit_report_closure_entries/' ?>',
      data: '',
      beforeSend :function(){
  ...
  $('#activityModelClk1').click(function(){
    ...
    var id = $('#credit_report_id').val();
    var component = 'credit_report';
...
$(document).on('click','#activityModelClk1',function() {
 ...
 var credit_report_result_id  = $('#credit_report_result_id1').val();


 document.getElementById("cbrver_id").value = component_id; 
 ...
 document.getElementById("credit_report_result_id").value = credit_report_result_id; 
