...
<div class="col-md-3 col-sm-12 col-xs-3 form-group">
  ...
  <input type="text" name="pcc_com_ref" id="pcc_com_ref"  value="<?php echo set_value('pcc_com_ref',$details['pcc_com_ref']); ?>" class="form-control cls_readonly">
</div>
</div>
<div class="row">
...
<div class="col-md-6 col-sm-12 col-xs-6 form-group">
     ...
     <input type="file" name="attchments_file[]" accept=".png, .jpg, .jpeg, .tiff, .pdf" multiple="multiple" id="attchments_file" value="<?php echo set_value('attchments'); ?>" class="form-control">
