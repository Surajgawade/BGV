      <div class="row">
         <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Court - Assign Court</h4>
                  <ol class="breadcrumb">
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>dashboard"><?php echo SHORT_CO_NAME ?></a></li>
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>court_verificatiion">Court</a></li>
                     <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_URL ?>assign_court">Assign Court</a></li>
                     <li class="breadcrumb-item active">List View</li>
                  </ol>
            
                  <div class="state-information d-none d-sm-block">
                    <ol class="breadcrumb">
                      <?php $access_export = ($this->permission['access_court_list_export']) ? '#myModalExport'  : ''; ?>
          ...
          <div class="card m-b-20">
            <div class="card-body">
              <div class="row">
                ...
                <table id="tbl_datatable_court_assign" class="table table-bordered  nowrap"  style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                  <thead>
                    <tr>
                      <th>Sr No</th>
                      <th>Client Ref No</th>
...
$(document).ready(function() {
  ...
  var oTable =  $('#tbl_datatable_court_assign').DataTable( {
        "serverSide": true,
        "processing": true,
         bSortable: true,
         bRetrieve: true,
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: "<?php echo ADMIN_SITE_URL.'assign_court/court_view_datatable_assign'; ?>",
            pages: 1,
            async: true,
            method: 'POST',
        ...
        "columns":[{'data' :'id'},{'data' :'ClientRefNumber'},{"data":"court_com_ref"},{"data":"iniated_date"},{"data":"clientname"},{'data' :'CandidateName'},{'data' :'vendor_name'},{'data' :'verfstatus'},{"data":"street_address"},{"data":"state"},{"data":"city"},{"data":"executive_name"},{'data':'first_qc_approve'},{'data':'tat_status'},{'data':'due_date'},{'data':"last_activity_date"}]
  } );
  ...
  $('#tbl_datatable_court_assign tbody').on('dblclick', 'tr', function () { 
  ...
  $('#tbl_datatable_court_assign tbody').on( 'click', 'tr', function () {
    ...
    $('#tbl_datatable_court_assign').on('click', 'tbody td, thead th:first-child', function(e){
  ...
  $('#btn_assign_action_vendor').on('click', function(e){
    ...
    if(vendor_list != "0" && select_one != "")
    {
        $.ajax({
          type:'POST',
          url:'<?php echo ADMIN_SITE_URL.'court_verificatiion/assign_to_vendor/' ?>',
