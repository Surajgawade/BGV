              ...
              <div class="box-header">
                <div class="box-body">
                  <table id="tbl_datatable" class="table table-bordered table-hover">
                    <thead><tr>
                     <th>Sr No.</th><th>Client Name</th><th>Entity</th><th>Package</th><th>Client Ref No</th><th><?php echo REFNO; ?></th><th>Candidate Name</th><th>Received Date</th><th>Component Ref No</th><th>Component Initiation Date</th><th>Appointment Date</th><th>Appointment Time</th><th>Spoc Phone Number</th><th>Drug Test Panel/Code</th><th>Facility Name/Code</th><th>Street Address</th><th>City</th><th>Pincode</th><th>State</th><th>Vendor</th><th>Executive Name</th><th>Mode of verification</th><th>Amphetamine Screen, Urine</th><th>Cannabinoids Screen, Urine</th><th>Cocaine Screen, Urine</th><th>Opiates Screen, Urine</th><th>Phencyclidine Screen, Urine</th><th>Attachment</th><th>Verification Status</th><th>Remarks</th><th>QC Status</th><th>TAT Status</th><th>Check Closure Date</th><th>Last Activity</th>
                      </tr>
                    </thead>
                      <?php
                      $x = 1;
                      foreach ($lists as $key => $list) {
                        echo "<tr>";
                          ...
                          echo "<td>".$list['drug_com_ref']."</td>";
                          echo "<td>".$list['iniated_date']."</td>";
                          echo "<td>".$list['appointment_date']."</td>";
                          echo "<td>".$list['appointment_time']."</td>";
                          echo "<td>".$list['spoc_no']."</td>";
                          echo "<td>".$list['drug_test_code']."</td>";
                          echo "<td>".$list['facility_name']."</td>";
                          echo "<td>".$list['street_address']."</td>";
                          echo "<td>".$list['city']."</td>";
                          echo "<td>".$list['pincode']."</td>";
                          echo "<td>".$list['state']."</td>";
                          echo "<td>".$list['vendor_id']."</td>";
                          echo "<td>".$list['executive_name']."</td>";
                          echo "<td>".$list['mode_of_verification']."</td>";
                          echo "<td>".$list['amphetamine_screen']."</td>";
                          echo "<td>".$list['cannabinoids_screen']."</td>";
                          echo "<td>".$list['cocaine_screen']."</td>";
                          echo "<td>".$list['opiates_screen']."</td>";
                          echo "<td>".$list['phencyclidine_screen']."</td>";
                          echo "<td>".$list['file_name']."</td>";
