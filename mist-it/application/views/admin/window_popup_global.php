                    ...
                    <thead><tr>
                      ...
                      foreach ($lists as $key => $list) {
                        echo "<tr>";
                          ...
                          echo "<td>".$list['global_com_ref']."</td>";
