                    ...
                    <table id="tbl_activity_log"  class="table table-bordered  nowrap"  style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                      ...
                      <?php
                        ...
                        foreach ($vendor_executive_list as $key => $value) {
                            ...
                            $html_view .= "<tr id = ".$value['drug_narcotis_id']." url = ".ADMIN_SITE_URL."drugs_narcotics/View_vendor_log1/".$value['id']." >";
                            $html_view .= "<td>".$i."</td>";
                            ...
                            $html_view .= "<td>".$value['drug_com_ref']."</td>";
...
/*$('#filter_executive').on('change', function(){
    ...
    $.ajax({
            type:'GET',
            url:'<?php echo ADMIN_SITE_URL.'court_verificatiion/court_closure_entries/' ?>'+filter_executive,
            data : '',
            dataType:'html',
