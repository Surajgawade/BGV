...
<input type="hidden" name="courtver_id" id="court_id" value="<?php echo set_value('court_id',$details['id']); ?>">
...
<input type="hidden" name="component_ref_no" id="component_ref_no" value="<?php echo set_value('component_ref_no',$details['court_com_ref']); ?>">
...
<input type="hidden" name="courtver_result_id" id="court_result_id1" value="<?php echo set_value('court_result_id',$details['court_result_id']); ?>">
...
<div class="col-md-3 col-sm-12 col-xs-3 form-group">
  ...
  <input type="text" name="add_com_ref" id="add_com_ref"  value="<?php echo set_value('add_com_ref',$details['court_com_ref']); ?>" class="form-control cls_readonly">
</div>
</div>
<div class="row">
...
<script type="text/javascript">
 ...
 $('#adv_name').val('<?php echo $details['adv_name'] ?>');
 ...
 $(".status").change(function() {    
   ...
   if(status == 'Clear' || status == 'Possible Match')
   {
 ...
 var f_status = '<?php echo ucwords($details['final_status'])?>';
   ...
   if(f_status == 'Clear' || f_status == 'Possible Match')
   {
