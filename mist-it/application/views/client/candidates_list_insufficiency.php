...
$.fn.dataTable.pipeline = function ( opts ) {
    ...
    var conf = $.extend( {
        ...
        url: '<?php echo CLIENT_SITE_URL.'candidates_insufficiency/data_table_cands_view'; ?>/',
        data: {'status': status},  
...
$(document).ready(function() {
  ...
  $(document).on('click', '.view_details', function(){
    var id = "<?php echo CLIENT_SITE_URL.'candidates_insufficiency/view_details/' ?>"+$(this).data("raw_id");
