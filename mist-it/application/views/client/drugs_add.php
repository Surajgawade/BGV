  ...
  <div class = "row"> 
   ...
   <div class = "row">  
    ...
    <div class="col-md-8 col-sm-12 col-xs-8 form-group">
      <input type="submit" name="sbdrugs" id='sbdrugs' value="Submit" class="btn btn-success">
    ...
    submitHandler: function(form) 
    {
      $.ajax({
        ...
        success: function(jdata){
          ...
          if ($("input[name ='drugs_check']:checked").val() == '1') 
          {
              var candsid  =  $('#candsid').val();

              $.ajax({
                url : "<?php echo CLIENT_SITE_URL.'candidates/client_send_mail_to_candidate'; ?>",
                data : 'candidate_id='+candsid,
                type: 'post',
                async:false,
                cache: false,
                processData:false,
