...
<?php echo form_open_multipart('#', array('name'=>'credit_report_edit','id'=>'credit_report_edit')); ?>
  <div class="box-body">    
    
     
      <input type="hidden" name="update_id"  id="update_id" value="<?php echo set_value('update_id',$selected_data['credit_report_id']); ?>" class="form-control">
...
$(document).ready(function(){
  ...
  $('.readonly').prop('readonly', true);
    ...
    {
      $.ajax({
        url : '<?php echo CLIENT_SITE_URL.'Candidate_mail/update_credit_report'; ?>',
