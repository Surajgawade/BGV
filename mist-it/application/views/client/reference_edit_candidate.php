<div class="box box-primary">
  <div class="box-body">    
    <?php echo form_open_multipart('#', array('name'=>'reference_edit','id'=>'reference_edit')); ?>

      <input type="hidden" name="update_id" id="update_id" value="<?php echo set_value('update_id',$reference_details['reference_id']); ?>" class="form-control">
...
$(document).ready(function(){
  ...
  $('.readonly').prop('readonly', true);
    ...
    {
      $.ajax({
        url : '<?php echo CLIENT_SITE_URL.'candidate_mail/update_reference'; ?>',
