...
$.fn.dataTable.pipeline = function ( opts ) {
    ...
    var conf = $.extend( {
        ...
        url: '<?php echo CLIENT_SITE_URL.'candidates_wip/data_table_cands_view'; ?>/',
        data: {'status': status},  
...
$(document).ready(function() {
   var oTable =  $('#tbl_datatable1').DataTable( {
        ...
        "columns":[{"data":"id"},{"data":"caserecddate"},{"data":"CandidateName"},{"data":"ClientRefNumber"},{"data":"cmp_ref_no"},{"data":"overallstatus"},{"data":"view"},{"data":"encry_id"},{'data':'pending_check'},{'data':'insufficiency_check'},{'data':'closed_check'},{"data":"overallclosuredate"},{"data":"remarks"},]
    } );
  ...
  $(document).on('click', '.view_details', function(){
    var id = "<?php echo CLIENT_SITE_URL.'candidates_wip/view_details/' ?>"+$(this).data("raw_id");
//alert(id);exit();
