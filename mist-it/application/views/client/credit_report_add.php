...
<?php echo form_open_multipart('#', array('name'=>'credit_report_add','id'=>'credit_report_add')); ?>
  <div class="box-body">    
    ...
    ?>
      <input type="hidden" name="mod_of_veri"  id="mod_of_veri" value="<?php if(isset($mode_of_verification_value->cbrver)) { echo $mode_of_verification_value->cbrver; } ?>" class="form-control cls_disabled">
    ...
    <div class="col-md-4 col-sm-8 col-xs-4 form-group">
      ...
      <?php
       echo form_dropdown('doc_submited', array('' => 'Select','pan card' => 'PAN Card'), set_value('doc_submited'), 'class="custom-select" id="doc_submited"');
    ...
    <div class="col-md-4 col-sm-12 col-xs-4 form-group">
      <label>Attachments<span class="error">*</span></label>
     ...
     <div class="col-md-8 col-sm-12 col-xs-8 form-group">
      <input type="submit" name="sbcreditreport" id='sbcreditreport' value="Submit" class="btn btn-success">
...
$(document).ready(function(){
  ...
  $('.readonly').prop('readonly', true);
    ...
    {
      $.ajax({
        url : '<?php echo CLIENT_SITE_URL.'Credit_report/save_credit_report'; ?>',
        ...
        complete:function(){
          $('#sbcreditreport').attr('disabled',false);
