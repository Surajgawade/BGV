<div class="box box-primary">
  ...
  <?php echo form_open_multipart('#', array('name'=>'education_edit','id'=>'education_edit')); ?>

  <div class="box-body">    
     
      <input type="hidden" name="update_id" id="update_id" value="<?php echo set_value('update_id',$selected_data['education_id']); ?>" class="form-control">
      ...
      <input type="hidden" name="education_com_ref" readonly="readonly" value="<?php echo set_value('education_com_ref',$selected_data['education_com_ref']); ?>" class="form-control">
...
$(document).ready(function(){
  ...
  $('.readonly').prop('readonly', true);
    ...
    {
      $.ajax({
        url : '<?php echo CLIENT_SITE_URL.'candidate_mail/update_education'; ?>',
