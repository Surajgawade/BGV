...
<head>
	...
	<base href="<?=CLIENT_SITE_URL?>" target="_blank">
                ...
                <div class="card-body">
					...
					<div style="display:flex;">
	                    <h3 class="text-left m-0">
	                        <img src="<?php echo URL_LOGO ?>" alt="" height="90">
	                    </h3>
                        &nbsp; &nbsp; &nbsp;
					    <h3 class="text-right m-4">
                    ...
                    <h3 class="text-center m-0">
                        <a href="<?php CLIENT_SITE_URL  ?>" class="logo logo-admin"><img src="<?php echo SITE_IMAGES_URL ?>logo.png" alt="" height="35"></a>
                    </h3>
                    <?php } ?>
                        ...
                        <form class="form-horizontal m-t-30 validate-form" id="admin_login" method="post">
                            ...
                            <div class="form-group m-t-10 mb-0 row">
                                <div class="col-12 m-t-20">
                                    <a href="<?php echo CLIENT_SITE_URL.'Client_login/forgot'; ?>" class="text-muted"><i class="mdi mdi-lock"></i> Forgot your password?</a>
                                </div>
                            </div>
                        </form>
                    </div>
