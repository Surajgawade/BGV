...
<div class="box box-primary">
    <?php echo form_open_multipart('#', array('name'=>'employment_edit','id'=>'employment_edit')); ?>
  <div class="box-body"> 

      <input type="hidden" id = "update_id" name="update_id" value="<?php echo set_value('update_id',$empt_details['id']); ?>" class="form-control">   
    ...
    <div class="col-md-4 col-sm-12 col-xs-4 form-group">
        <label>&nbsp;</label>
          <label><span class="error"><h6 style="margin-left:20px;"><input type="checkbox" id="check_fresher" name="check_fresher" class="form-check-input" style="height: 20px;width: 20px;">&nbsp;&nbsp;Select this if you are a fresher </h6></span></label>
    </div>
    <div id="fresher_show_hide">
    ...
    <div class="col-md-4 col-sm-8 col-xs-4 form-group">
      ...
      <?php
         echo form_dropdown('nameofthecompany',$company_list, set_value('nameofthecompany'), 'class="form-control select2" id="nameofthecompany"');
    ...
    <div class="col-md-4 col-sm-12 col-xs-4 form-group">
      ...
      <input type="text" name="empfrom" id="empfrom" value="<?php echo set_value('empfrom'); ?>" class="form-control myDatepicker">
      <?php echo form_error('empfrom'); ?>
    </div>                  
    <div class="col-md-4 col-sm-12 col-xs-4 form-group">
      <label>Employed To  <span class="error"> *</span></label>
      <input type="text" name="empto" id="empto" value="<?php echo set_value('empto'); ?>" class="form-control myDatepicker" >
  ...
  $('.readonly').prop('readonly', true);
   ...
   $('#employment_edit').validate({
    ...
    messages: {
      ...
      empid : {
        required : "Enter Previous Employee Code"
      },
      "attchments[]" : {
    ...
    submitHandler: function(form) 
    {
      ...
      $.ajax({
        url : '<?php echo CLIENT_SITE_URL.'candidate_mail/update_employment'; ?>',
...
<script type="text/javascript">
  ...
  $(".select2").select2();
    ...
    $("#nameofthecompany").select2({
      ...
      ajax: 
      {
          url: "<?php echo CLIENT_SITE_URL.'candidate_mail/get_company_details' ?>",
          dataType: 'json',
          data: function(term) {
              return {
                  q: term
  ...
  $('#nameofthecompany').change(function(){
      ...
      {
        var id = '<?php echo CLIENT_SITE_URL.'candidate_mail/addAddCompanyModel'?>';
    ...
    $.ajax({  
      ...
      url: "<?php echo CLIENT_SITE_URL.'candidate_mail/get_required_fields' ?>",
      type: "post",
      async:false,
  ...
  $('#add_company').validate({ 
      ...
      {      
          $.ajax({
          url: '<?php echo CLIENT_SITE_URL.'candidate_mail/save_company'; ?>',
          data: new FormData(form),
          type: 'post',
          contentType:false,
          cache: false,
...
jQuery.validator.addMethod("multiemails", function (value, element) {
    ...
    $("#check_fresher").click(function() {
        if($(this).is(":checked")) {
            $("#fresher_show_hide").hide();
        } else {
            $("#fresher_show_hide").show();
        }
    });
</script>