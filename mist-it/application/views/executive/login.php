...
<body style='background: #f5f5f5;font-family: "Poppins", sans-serif;color: #5b626b;font-size: 13px;'>
          ...
          <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="text-center m-0">
                        <a href="<?php VENDOR_EXECUTIVE_SITE_URL  ?>" class="logo logo-admin"><img src="<?php echo SITE_IMAGES_URL ?>logo.png" alt="" height="35"></a>
                    </h3>

                    <h3 class="text-center m-3">
                        Vendor Executive Login
                    </h3>

                    <div class="p-3">
                        
                        <form class="form-horizontal m-t-30 validate-form" id="vendor_executive_login" method="post">
                        	
                            <div class="form-group validate-input venuser_name" data-validate = "Enter Mobile No">
                                <label for="venuser_name">Mobile No</label>
                                <input type="text" class="form-control" name="venuser_name" id="venuser_name" placeholder="Enter Mobile No"  minlength = "10" maxlength="10">
                            </div>
	...
	$(document).ready(function(){
		...
		$('#vendor_executive_login').validate({ 
		    rules: {
		        venuser_name : {
		          required : true,
		          minlength : 10,
			...
			{      
			  	$.ajax({
					url:"<?php echo VENDOR_EXECUTIVE_SITE_URL.'Executive_login/login'; ?>",
					type:'post',
