         ...
         <div class="col-sm-12">
            <div class="page-title-box">
                  <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item"><a href="<?php echo VENDOR_EXECUTIVE_SITE_URL ?>addrver_exe/addrver_exe_closed">Address Closed</a></li>
...
$(document).ready(function() {
  ...
  var oTable =  $('#tbl_datatable').DataTable( {
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: '<?php echo VENDOR_EXECUTIVE_SITE_URL.'addrver_exe/address_view_datatable_closed_executive'; ?>',
