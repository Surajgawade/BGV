...
<div id="myModalCasesedit" class="modal fade" role="dialog" data-backdrop="false">
  <div class="modal-dialog addr" >
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title header_title">Credit Report Edit</h4>
      </div>
      <div class="modal-body">
        <div class="row">
...
$(document).ready(function() {
  ...
  var oTable =  $('#tbl_datatable1').DataTable( {
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: '<?php echo VENDOR_SITE_URL.'cbrver/credit_report_view_datatable_assign_closed'; ?>',
        ...
        "columns":[{'data' :'checkbox'},{'data' :'created_on'},{"data":"CandidateName"},{'data' :'street_address'},{'data' :'city'},{'data' :'pincode'},{'data' :'state'},{'data' :'status'},{'data' :'vendor_executive_id'},{'data' :'test2'},{"data":"tat_status"},{'data':'vendor_list_mode'},{'data':'trasaction_id'},{'data':'credit_report_com_ref'},{'data':"client_ref_no"}]
  });
   ...
   $('#tbl_datatable1 tbody').on('dblclick', 'tr', function () { 
    var data = oTable.row( this ).data();
      ...
      $.ajax({
      type : 'POST',
      url : '<?php echo VENDOR_SITE_URL.'cbrver/view_vendor_logs/' ?>',
 ...
 $('#cases_assgin').on('change', function(e){
   ...
   $('#btn_assign_action').on('click', function(e){
    ...
    if(vendor_executive_list != '0'  && select_one != "")
    {
        $.ajax({
          type:'POST',
          url:'<?php echo VENDOR_SITE_URL.'cbrver/assign_to_executive/' ?>',
   ...
   $('#searchrecords').on('click', function() {
    ...
    {
    var new_url = "<?php echo VENDOR_SITE_URL.'cbrver/credit_report_view_datatable_assign_closed'; ?>?start_date="+start_date+"&end_date="+end_date;
...
$(document).ready(function(){
  ...
  $('#update_case').validate({
    ...
    submitHandler: function(form) 
    {
      ...
      $.ajax({
        url : '<?php echo VENDOR_SITE_URL.'cbrver/update_credit_report_wip'; ?>',
