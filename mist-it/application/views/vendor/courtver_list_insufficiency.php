     ...
     <div class="row">
         <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Vendor - Court - Insufficiency - List View</h4>
                  <ol class="breadcrumb">
                     <li class="breadcrumb-item"><a href="<?php echo VENDOR_SITE_URL ?>index"><?php echo SHORT_CO_NAME ?></a></li>
                     <li class="breadcrumb-item"><a href="<?php echo VENDOR_SITE_URL ?>courtver/courtver_insufficiency">Court Insufficiency</a></li>
...
$(document).ready(function() {
  ...
  var oTable =  $('#tbl_datatable1').DataTable( {
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: '<?php echo VENDOR_SITE_URL.'courtver/court_view_datatable_assign_insufficiency'; ?>',
