        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Vendor - Education - Closed - List View</h4>
                  <ol class="breadcrumb">
                     <li class="breadcrumb-item"><a href="<?php echo VENDOR_SITE_URL ?>index"><?php echo SHORT_CO_NAME ?></a></li>
                     <li class="breadcrumb-item"><a href="<?php echo VENDOR_SITE_URL ?>eduver/eduver_closed">Education Closed</a></li>
              ...
              <div class="card-body">
                      ...
                      <div class="col-md-2 col-sm-12 col-xs-3 form-group">
                       ...
                       <div class="col-md-2 col-sm-12 col-xs-3 form-group">
                        ...
                        $filter_status = array('All' => "All", 'clear' => 'Clear','major discrepancy' => 'Major Discrepancy','minor discrepancy' => 'Minor Discrepancy','no record found' => 'No Record Found','unable to verify' => 'Unable to Verify', 'approved' => 'Approved');
                          echo form_dropdown('filter_by_status', $filter_status, set_value('filter_by_status'), 'class="form-control" id="filter_by_status"');
                    ...
                    <button class="btn btn-secondary waves-effect" id="export_education_cases" data-toggle="modal" data-target="#myModalExport" ><i class="fa fa-download"></i>  Export Excel</button> 
                    <?php echo form_close(); ?>

                  <form method="post" action="<?php echo VENDOR_SITE_URL.'eduver/export_education_doc'?>">
                   <input type="hidden" name="component_status_doc" id="component_status_doc" class="form-control" value="closed">
...
$(document).ready(function() {
  ...
  var oTable =  $('#tbl_datatable1').DataTable( {
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: '<?php echo VENDOR_SITE_URL.'eduver/education_view_datatable_assign_closed'; ?>',
        ...
        "columns":[{'data' :'checkbox'},{'data' :'modified_on'},{"data":"CandidateName"},{'data' :'school_college'},{'data' :'university_board'},{'data' :'status'},{'data' :'city'},{'data' :'state'},{'data' :'vendor_executive_id'},{"data":"tat_status"},{'data' :'due_date'},{'data':'vendor_list_mode'},{'data':'trasaction_id'},{'data':'education_com_ref'},{'data':"client_ref_no"},{'data':"cmp_ref_no"}],
   ...
   var new_url = "<?php echo VENDOR_SITE_URL.'eduver/education_view_datatable_assign_closed'; ?>?filter_by_status="+filter_by_status+"&start_date="+start_date+"&end_date="+end_date;
    ...
    var new_url = "<?php echo VENDOR_SITE_URL.'eduver/education_view_datatable_assign_closed'; ?>?start_date="+start_date+"&end_date="+end_date+"&filter_by_status="+filter_by_status;
    oTable.ajax.url(new_url).load();
  });
  ...
  $('#filter_by_status').on('change', function(){
    ...
    oTable.ajax.url(new_url).load();
             ...
             //alert($('#tbl_datatable1').find("tr:last").text());
...
$("#download_education_files").submit();
});
...
$(document).ready(function(){
  ...
  $('#export_education').validate({
    ...
    submitHandler: function(form) 
    {
        ...
        var exportData = new FormData(form);
        exportData.append('start_date',$('#start_date').val());
        exportData.append('end_date',$('#end_date').val());
        exportData.append('filter_by_status',$("#filter_by_status option:selected").text());
