       ...
       <div class="row">
         <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Vendor - Global Database - Closed - List View</h4>
                  <ol class="breadcrumb">
                     <li class="breadcrumb-item"><a href="<?php echo VENDOR_SITE_URL ?>index"><?php echo SHORT_CO_NAME ?></a></li>
                     <li class="breadcrumb-item"><a href="<?php echo VENDOR_SITE_URL ?>globdbver/globdbver_closed">Global Database Closed</a></li>
...
<div id="myModalCasesedit" class="modal fade" role="dialog" data-backdrop="false">
  <div class="modal-dialog addr modal-lg" >
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title header_title">Global Edit</h4>
      </div>
      <div class="modal-body">
...
$(document).ready(function() {
  ...
  var oTable =  $('#tbl_datatable1').DataTable( {
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: '<?php echo VENDOR_SITE_URL.'globdbver/global_view_datatable_assign_closed'; ?>',
        ...
        "columns":[{'data' :'checkbox'},{'data' :'created_on'},{'data' :'modified_on'},{"data":"CandidateName"},{'data' :'street_address'},{'data' :'city'},{'data' :'pincode'},{'data' :'state'},{'data' :'status'},{'data' :'vendor_executive_id'},{'data' :'test2'},{"data":"tat_status"},{'data':'vendor_list_mode'},{'data':'trasaction_id'},{'data':'global_com_ref'}]
  });
   ...
   $('#tbl_datatable1 tbody').on('dblclick', 'tr', function () { 
    var data = oTable.row( this ).data();
      ...
      $.ajax({
      type : 'POST',
      url : '<?php echo VENDOR_SITE_URL.'globdbver/view_vendor_logs/' ?>',
 ...
 $('#cases_assgin').on('change', function(e){
   ...
   $('#btn_assign_action').on('click', function(e){
    ...
    if(vendor_executive_list != '0'  && select_one != "")
    {
        $.ajax({
          type:'POST',
          url:'<?php echo VENDOR_SITE_URL.'globdbver/assign_to_executive/' ?>',
 ...
 $('#searchrecords').on('click', function() {
    ...
    {
    var new_url = "<?php echo VENDOR_SITE_URL.'globdbver/global_view_datatable_assign_closed'; ?>?filter_by_status="+filter_by_status+"&start_date="+start_date+"&end_date="+end_date;
   ...
   $('#btn_reset').on('click', function() {
    ...
    var new_url = "<?php echo VENDOR_SITE_URL.'globdbver/global_view_datatable_assign_closed'; ?>?start_date="+start_date+"&end_date="+end_date+"&filter_by_status="+filter_by_status;
    oTable.ajax.url(new_url).load();
  });
...
$(document).ready(function(){
  ...
  $('#update_case').validate({
    ...
    submitHandler: function(form) 
    {
      ...
      $.ajax({
        url : '<?php echo VENDOR_SITE_URL.'globdbver/update_global_wip'; ?>',
