    ...
    <div class="row">
         <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Vendor - Drugs - Closed - List View</h4>
                  <ol class="breadcrumb">
                     <li class="breadcrumb-item"><a href="<?php echo VENDOR_SITE_URL ?>index"><?php echo SHORT_CO_NAME ?></a></li>
                     <li class="breadcrumb-item"><a href="<?php echo VENDOR_SITE_URL ?>narcver/narcver_closed">Drugs Closed</a></li>
            ...
            <div class="card m-b-20">
              <div class="card-body">
                  ...
                  <div class="row">
                        ...
                        $filter_status = array('All' => "All", 'closed' => 'Pending', 'approved' => 'Approved');
...
$(document).ready(function() {
  ...
  var oTable =  $('#tbl_datatable').DataTable( {
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: '<?php echo VENDOR_SITE_URL.'narcver/narcver_view_datatable_assign_closed'; ?>',
        ...
        "columns":[{'data' :'checkbox'},{'data' :'created_on'},{'data' :'modified_on'},{"data":"CandidateName"},{'data' :'street_address'},{'data' :'city'},{'data' :'pincode'},{'data' :'state'},{'data' :'status'},{"data":"tat_status"},{'data':'vendor_list_mode'},{'data':'clientname'},{'data':'entity_name'},{'data':'trasaction_id'},{'data':'drug_com_ref'},{'data':"client_ref_no"}]
  });
 ...
 $('#searchrecords').on('click', function() {
    ...
    {
    var new_url = "<?php echo VENDOR_SITE_URL.'narcver/narcver_view_datatable_assign_closed'; ?>?filter_by_status="+filter_by_status+"&start_date="+start_date+"&end_date="+end_date;
   ...
   $('#btn_reset').on('click', function() {
    ...
    var new_url = "<?php echo VENDOR_SITE_URL.'narcver/narcver_view_datatable_assign_closed'; ?>?start_date="+start_date+"&end_date="+end_date+"&filter_by_status="+filter_by_status;
    oTable.ajax.url(new_url).load();
  });
