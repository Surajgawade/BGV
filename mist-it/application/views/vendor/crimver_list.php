                    ...
                    <div class="content">
                        ...
                        <table class="table table-hover dataTable no-footer" id="tbl_datatable">
                            ...
                            foreach ($lists as $key => $value) {
                                ...
                                echo "<tr>";
                                echo "<td><input type='checkbox' name='cases_id[]' id='cases_id' value='".$value['id']."' class='select-checkbox'></td>";
                                echo "<td><input type='button' id='".$value['id']."' class='btn btn-warning btn-sm' value='Action'></td>";
