        ...
        <div class="row">
         <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Vendor - Education - WIP - List View</h4>
                  <ol class="breadcrumb">
                     <li class="breadcrumb-item"><a href="<?php echo VENDOR_SITE_URL ?>index"><?php echo SHORT_CO_NAME ?></a></li>
                     <li class="breadcrumb-item"><a href="<?php echo VENDOR_SITE_URL ?>eduver/eduver_wip">Education WIP</a></li>
          ...
          <div class="col-12">
            <div class="card m-b-20">
              <div class="card-body">
                  ...
                  <input type="hidden" name="component_status" id="component_status" class="form-control" value="wip">
                  ...
                  <form method="post" action="<?php echo VENDOR_SITE_URL.'eduver/export_education_doc'?>">
                   <input type="hidden" name="component_status_doc" id="component_status_doc" class="form-control" value="wip">
...
$(document).ready(function() {
  ...
  var oTable =  $('#tbl_datatable1').DataTable( {
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: '<?php echo VENDOR_SITE_URL.'eduver/education_view_datatable_assign_wip'; ?>',
