<div class="box box-primary">
  ...
  <div class="box-body">    
      ...
      <input type="hidden" name="component_name" id="component_name" value="PCC" class="form-control" >
      <input type="hidden" name="comp_ref_no" id="comp_ref_no" value="<?php echo set_value('comp_ref_no',$details[0]['pcc_com_ref']); ?>" class="form-control" >
      <input type="hidden" name="pcc_id"  value="<?php echo set_value('pcc_id',$id); ?>" class="form-control">
