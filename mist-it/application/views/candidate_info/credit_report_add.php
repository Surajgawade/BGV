<div class="box box-primary">
  ...
  <div class="box-body">    
      ...
      <input type="hidden" name="component_name" id="component_name" value="Credit Report" class="form-control" >
      <input type="hidden" name="comp_ref_no" id="comp_ref_no" value="<?php echo set_value('comp_ref_no',$details[0]['credit_report_com_ref']); ?>" class="form-control" >
      <input type="hidden" name="credit_report_id"  value="<?php echo set_value('credit_report_id',$id); ?>" class="form-control">
    ...
    <div class="col-md-4 col-sm-8 col-xs-4 form-group">
      ...
      <?php
       echo form_dropdown('doc_submited', array('' => 'Select','aadhar card' => 'Aadhar Card',
        'pan card' => 'PAN Card'), set_value('doc_submited'), 'class="form-control" id="doc_submited"');
