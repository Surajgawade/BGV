                ...
                <table id="tbl_datatable1" class="table table-bordered table-hover">
                  <thead>
                    <tr class="filters">
                      ...
                      <th><input type="text" class="form-control" placeholder="Reference Name" ></th>
...
<div id="addAddreferenceModel" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
<div class="modal-dialog" style="overflow-y: scroll; max-height:90%;width: 80%;  margin-top: 40px; margin-bottom:40px;">
    ...
    <div class="modal-content">
      ...
      <div id="append_add_reference_model"></div>
      <div class="modal-footer">
        <button type="button" id="addreferenceBack" name="addreferenceBack" class="btn btn-default btn-sm pull-left">Back</button>
        <button type="submit" id="sbreference" name="sbreference" class="btn btn-success btn-sm">Submit</button>
...
$.fn.dataTable.pipeline = function ( opts ) {
    ...
    var conf = $.extend( {
        ...
        url: '<?php echo CANDIDATE_SITE_URL.'reference/reference_view'; ?>/',
        data: {'status': status},  
...
$(document).ready(function() {
  ...
  $('#tbl_datatable1 tbody').on('dblclick', 'tr', function () { 
    ...
    $('#append_add_reference_model').load(url,function(){
 ...
 $('#reference_add').validate({ 
      ...
      name_of_reference : {
        required : function(){
          ...
          if ($("input[name ='reference_check']:checked").val() == '1') 
          {
            return false;
          }
          else
    ...
    messages: {
      name_of_reference : {
        required : function(){
          ...
          {
            return "Enter Name of Reference";
          }
        }
    ...
    {
      $.ajax({
        url : '<?php echo CANDIDATE_SITE_URL.'reference/save_reference'; ?>',
