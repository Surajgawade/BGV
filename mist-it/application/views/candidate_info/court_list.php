...
<div id="addAddcourtModel" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
<div class="modal-dialog" style="overflow-y: scroll; max-height:90%;width: 80%;  margin-top: 40px; margin-bottom:40px;">

    <?php echo form_open_multipart("#", array('name'=>'court_add','id'=>'court_add')); ?>
    <div class="modal-content">
      ...
      <div id="append_add_court_model"></div>
      <div class="modal-footer">
        <button type="button" id="addcourtBack" name="addcourtBack" class="btn btn-default btn-sm pull-left">Back</button>
        <button type="submit" id="sbcourt" name="sbcourt" class="btn btn-success btn-sm">Submit</button>
...
$.fn.dataTable.pipeline = function ( opts ) {
    ...
    var conf = $.extend( {
        ...
        url: '<?php echo CANDIDATE_SITE_URL.'Court/court_view'; ?>/',
        data: {'status': status},  
...
$(document).ready(function() {
  ...
  $('#tbl_datatable1 tbody').on('dblclick', 'tr', function () { 
    ...
    $('#append_add_court_model').load(url,function(){
 ...
 $('#court_add').validate({ 
      ...
      street_address : {
        required : function(){
          ...
          if ($("input[name ='court_check']:checked").val() == '1') 
          {
            return false;
          }
          else
    ...
    {
      $.ajax({
        url : '<?php echo CANDIDATE_SITE_URL.'Court/save_court'; ?>',
        ...
        dataType:'json',
        beforeSend:function(){
          $('#sbcourt').attr('disabled','disabled');
