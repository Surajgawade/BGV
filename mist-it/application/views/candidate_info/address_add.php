<div class="box box-primary">
  ...
  <div class="box-body">    
      ...
      <input type="hidden" name="CandidateName" readonly="readonly" value="<?php echo set_value('CandidateName',$get_cands_details['CandidateName']); ?>" class="form-control">
       ...
       <input type="hidden" name="component_name" id="component_name" value="Address" class="form-control" >
       <input type="hidden" name="comp_ref_no" id="comp_ref_no" value="<?php echo set_value('comp_ref_no',$details[0]['add_com_ref']); ?>" class="form-control" >
       <input type="hidden" name="address_id"  value="<?php echo set_value('address_id',$id); ?>" class="form-control">
    <?php
