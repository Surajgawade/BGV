                ...
                <table id="tbl_datatable1" class="table table-bordered table-hover">
                  <thead>
                    <tr class="filters">
                        ...
                        <th><input type="text" class="form-control" placeholder="School/College" ></th>
                        <th><input type="text" class="form-control" placeholder="University" ></th>
                        <th><input type="text" class="form-control" placeholder="Qualification" ></th>
                        <th><input type="text" class="form-control" placeholder="Year of Passing" ></th>
                       ...
                       <!-- <th><input type="text" class="form-control" placeholder="QC Status" ></th>-->
                        ...
                        <th><input type="text" class="form-control" placeholder="Mode Of Verificaion" ></th>
...
<div id="addAddeducationModel" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
<div class="modal-dialog" style="overflow-y: scroll; max-height:90%;width: 80%;  margin-top: 40px; margin-bottom:40px;">
    ...
    <div class="modal-content">
      ...
      <div id="append_add_education_model"></div>
      <div class="modal-footer">
        <button type="button" id="addeducationBack" name="addeducationBack" class="btn btn-default btn-sm pull-left">Back</button>
        <button type="submit" id="sbeducation" name="sbeducation" class="btn btn-success btn-sm">Submit</button>
...
$.fn.dataTable.pipeline = function ( opts ) {
    ...
    var conf = $.extend( {
        ...
        url: '<?php echo CANDIDATE_SITE_URL.'education/education_view'; ?>/',
        data: {'status': status},  
...
$(document).ready(function() {
  ...
  $('#tbl_datatable1 tbody').on('dblclick', 'tr', function () { 
    ...
    $('#append_add_education_model').load(url,function(){
 ...
 $('#education_add').validate({ 
     rules: {
      qualification : {
        required : function(){
          ...
          if ($("input[name ='education_check']:checked").val() == '1') 
          {
            return false;
          }
          else
    ...
    messages: {
      ...
      university_board : {
        ...
        required : function(){
          ...
          {
            return "Select University/Board";
          }
        }
    ...
    {
      $.ajax({
        url : '<?php echo CANDIDATE_SITE_URL.'education/save_education'; ?>',
