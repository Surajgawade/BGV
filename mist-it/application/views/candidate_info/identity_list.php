...
<div id="addAddidentityModel" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
<div class="modal-dialog" style="overflow-y: scroll; max-height:90%;width: 80%;  margin-top: 40px; margin-bottom:40px;">
    ...
    <div class="modal-content">
      ...
      <div id="append_add_identity_model"></div>
      <div class="modal-footer">
        <button type="button" id="addidentityBack" name="addidentityBack" class="btn btn-default btn-sm pull-left">Back</button>
        <button type="submit" id="sbidentity" name="sbidentity" class="btn btn-success btn-sm">Submit</button>
...
$.fn.dataTable.pipeline = function ( opts ) {
    ...
    var conf = $.extend( {
        ...
        url: '<?php echo CANDIDATE_SITE_URL.'identity/identity_view'; ?>/',
        data: {'status': status},  
...
$(document).ready(function() {
  ...
  $('#tbl_datatable1 tbody').on('dblclick', 'tr', function () { 
    ...
    $('#append_add_identity_model').load(url,function(){
 ...
 $('#identity_add').validate({ 
      ...
      doc_submited : {
        required : function(){
          ...
          if ($("input[name ='identity_check']:checked").val() == '1') 
          {
            return false;
          }
          else
    ...
    {
      $.ajax({
        url : '<?php echo CANDIDATE_SITE_URL.'identity/save_identity'; ?>',
