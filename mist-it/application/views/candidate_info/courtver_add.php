<div class="box box-primary">
  ...
  <div class="box-body">    
      ...
      <input type="hidden" name="component_name" id="component_name" value="Court" class="form-control" >
      <input type="hidden" name="comp_ref_no" id="comp_ref_no" value="<?php echo set_value('comp_ref_no',$details[0]['court_com_ref']); ?>" class="form-control" >
      <input type="hidden" name="court_id"  value="<?php echo set_value('court_id',$id); ?>" class="form-control">
    ...
    ?>
      <input type="hidden" name="mod_of_veri"  id="mod_of_veri" value="<?php if(isset($mode_of_verification_value->courtver)) { echo $mode_of_verification_value->courtver; } ?>" class="form-control cls_disabled">
