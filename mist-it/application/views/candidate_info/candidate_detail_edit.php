            ...
            <div class="card-body">
              <div class="col-md-4 col-sm-8 col-xs-4 form-group">
                ...
                <div class="col-md-4 col-sm-12 col-xs-4 form-group">
                 ...
                 <div class="col-md-4 col-sm-12 col-xs-4 form-group">
                  <label>Data Entry<span class="error">*</span></label>
                  <input type="file" name="attchments[]" accept=".png, .jpg, .jpeg,.eml,.pdf,.docx,.xls,.xlsx" multiple="multiple" id="attchments" value="<?php echo set_value('attchments'); ?>" class="form-control">
                  <?php echo form_error('attchments'); ?>
                </div>
                <div class="clearfix"></div>
          ...
          <div id="DrugsCollapse" class="collapse" role="tabpanel" aria-labelledby="headingThree31"
            ...
            <div class="card-body">
                ...
                <!--<div class="col-md-4 col-sm-8 col-xs-4 form-group">
                  ...
                  <input type="text" name="spoc_no" maxlength="12" minlength="8" id="spoc_no" value="<?php echo set_value('spoc_no'); ?>" class="form-control">
                  <?php echo form_error('spoc_no'); ?>
                </div>-->
                <div class="clearfix"></div>
...
$('#create_reference').validate({ 
    ...
    submitHandler: function(form) 
    {
      $.ajax({
        ...
        dataType:'json',
        beforeSend:function(){
          $('#save_reference').attr('disabled','disabled');
          jQuery('.body_loading').show();
        },
        complete:function(){
          $('#save_reference').attr('disabled',false);
          jQuery('.body_loading').hide();
        },
        success: function(jdata){
          var message =  jdata.message || '';
 ...
 $('#create_court').validate({ 
    ...
    submitHandler: function(form) 
    {
      $.ajax({
        ...
        dataType:'json',
        beforeSend:function(){
          $('#save_court').attr('disabled','disabled');
          jQuery('.body_loading').show();
        },
        complete:function(){
          $('#save_court').attr('disabled',false);
          jQuery('.body_loading').hide();
        },
        success: function(jdata){
          var message =  jdata.message || '';
 ...
 $('#create_global').validate({ 
    ...
    submitHandler: function(form) 
    {
      $.ajax({
        ...
        dataType:'json',
        beforeSend:function(){
          $('#save_global').attr('disabled','disabled');
          jQuery('.body_loading').show();
        },
        complete:function(){
          $('#save_global').attr('disabled',false);
          jQuery('.body_loading').hide();
        },
        success: function(jdata){
          var message =  jdata.message || '';
  ...
  $('#create_pcc').validate({ 
    ...
    messages: {
      ...
      "references[]" : {
       ...
       "references_no[]" : {
          required : "Enter References Contact No"
      }
    },
    submitHandler: function(form) 
    {
 ...
 $('#create_identity').validate({ 
    ...
    messages: {
      ...
      doc_submited : {
        ...
        greaterThan:  "Select Doc Submitted"
      },
       "attchments[]" : {
    ...
    submitHandler: function(form) 
    {
      $.ajax({
        ...
        dataType:'json',
        beforeSend:function(){
          $('#save_identity').attr('disabled','disabled');
          jQuery('.body_loading').show();
        },
        complete:function(){
          $('#save_identity').attr('disabled',false);
          jQuery('.body_loading').hide();
        },
        success: function(jdata){
          var message =  jdata.message || '';
