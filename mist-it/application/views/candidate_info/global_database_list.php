...
<div id="addAddglobalModel" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
<div class="modal-dialog" style="overflow-y: scroll; max-height:90%;width: 80%;  margin-top: 40px; margin-bottom:40px;">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Add Global</h4>
      </div>
      <span class="errorTxt"></span>
    
      <div id="append_add_global_model"></div>
      <div class="modal-footer">
        <button type="button" id="addglobalBack" name="addglobalBack" class="btn btn-default btn-sm pull-left">Back</button>
        <button type="submit" id="sbglobal" name="sbglobal" class="btn btn-success btn-sm">Submit</button>
...
$.fn.dataTable.pipeline = function ( opts ) {
    ...
    var conf = $.extend( {
        ...
        url: '<?php echo CANDIDATE_SITE_URL.'global_database/global_database_view'; ?>/',
        data: {'status': status},  
...
$(document).ready(function() {
  ...
  $('#tbl_datatable1 tbody').on('dblclick', 'tr', function () { 
    ...
    $('#append_add_global_model').load(url,function(){
 ...
 $('#global_add').validate({ 
      ...
      street_address : {
        required : function(){
        if ($("input[name ='global_check']:checked").val() == '1') 
          {
            return false;
          }
          else
    ...
    {
      $.ajax({
        url : '<?php echo CANDIDATE_SITE_URL.'Global_database/save_global_database'; ?>',
