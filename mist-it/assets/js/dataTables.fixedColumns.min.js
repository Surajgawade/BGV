...
d.append(this.dom.rightTopBlocker)));n&&(this.s.rtl?(this.dom.leftBottomBlocker.outerHeight(c),d.append(this.dom.leftBottomBlocker)):(this.dom.rightBottomBlocker.outerHeight(c),d.append(this.dom.rightBottomBlocker)))};e.prototype._getCellCSS=function(d,g,m){return"left"===m?this.s.rtl?{position:"sticky",right:g+(d?this.s.barWidth:0)+"px"}:{left:g+"px"}:this.s.rtl?{left:g+"px",position:"sticky"}:{position:"sticky",right:g+(d?this.s.barWidth:0)+"px"}};e.prototype._clearCellCSS=function(d){return"left"===
